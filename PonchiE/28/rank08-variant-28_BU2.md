...
<svg viewBox="0 0 1280 720" xmlns="http://www.w3.org/2000/svg">
  ...
  <rect x="1032" y="116" width="208" height="452" rx="18" fill="url(#gGoal)" filter="url(#sh)"/>
  <g opacity="0.16" fill="none" stroke="#ffffff" stroke-width="2"><path d="M1126 150 L1130 138 L1134 150 L1146 154 L1134 158 L1130 170 L1126 158 L1114 154 Z"/></g>
  <circle cx="1058" cy="150" r="14" fill="#ffffff"/>
  <g transform="translate(1058,150)" stroke="#1c6e44" stroke-width="2" fill="none"><circle cx="0" cy="0" r="8"/><circle cx="0" cy="0" r="3.5"/></g>
  <text x="1082" y="164" font-size="34" font-weight="700" fill="#ffffff">GOAL</text>
  <text x="1048" y="196" font-size="13.5" fill="#dff1e7">研究×学びがつながり、</text>
  <text x="1048" y="217" font-size="13.5" font-weight="700" fill="#ffffff">学生と教職員が躍動する</text>
  <text x="1048" y="238" font-size="13.5" font-weight="700" fill="#ffffff">大学へ！</text>
  <line x1="1048" y1="256" x2="1224" y2="256" stroke="#ffffff" stroke-width="1" opacity="0.3"/>
  <path d="M1050 282 L1058 282 M1055 278 L1059 282 L1055 286" stroke="#bff0d6" stroke-width="2" fill="none"/>
  <text x="1068" y="286" font-size="12.5" font-weight="700" fill="#ffffff">教職員の生産性UP！</text>
  <rect x="1048" y="304" width="176" height="156" rx="10" fill="#ffffff" opacity="0.15"/>
  <text x="1136" y="324" font-size="12" font-weight="700" fill="#ffffff" text-anchor="middle">YOKOTE VISIONの実現</text>
  <circle cx="1060" cy="344" r="6.5" fill="#bff0d6"/>
  <text x="1060" y="344" font-size="8.5" font-weight="800" fill="#1c6e44" text-anchor="middle" dominant-baseline="central">1</text>
  <text x="1074" y="348" font-size="8.8" font-weight="700" fill="#ffffff">個人の才能・独創性を引き出す</text>
  <circle cx="1060" cy="368" r="6.5" fill="#bff0d6"/>
  <text x="1060" y="368" font-size="8.5" font-weight="800" fill="#1c6e44" text-anchor="middle" dominant-baseline="central">2</text>
  <text x="1074" y="372" font-size="8.8" font-weight="700" fill="#ffffff">世界に冠たる</text>
  <text x="1074" y="384" font-size="8.8" font-weight="700" fill="#ffffff">「独創的な研究」の促進</text>
  <text x="1074" y="397" font-size="8.0" fill="#dff1e7">（国際＆学際、地域社会共創）</text>
  <circle cx="1060" cy="418" r="6.5" fill="#bff0d6"/>
  <text x="1060" y="418" font-size="8.5" font-weight="800" fill="#1c6e44" text-anchor="middle" dominant-baseline="central">3</text>
  <text x="1074" y="422" font-size="8.8" font-weight="700" fill="#ffffff">専門や職種を超えた</text>
  <text x="1074" y="434" font-size="8.8" font-weight="700" fill="#ffffff">学内協働・対話の促進</text>
  <rect x="1048" y="468" width="176" height="88" rx="10" fill="#ffffff" opacity="0.15"/>
  <text x="1136" y="492" font-size="12.5" fill="#eafaf1" text-anchor="middle">学内すべての成果が</text>
  <text x="1136" y="511" font-size="12.5" fill="#eafaf1" text-anchor="middle">連鎖的に伸びる</text>
  <text x="1136" y="536" font-size="16" font-weight="700" fill="#ffffff" text-anchor="middle">好循環へ</text>
  <text x="42" y="586" font-size="11" font-weight="700" fill="#9a9a9a">想定する効果</text>
  <rect x="40" y="592" width="308" height="54" rx="10" fill="#ffffff" filter="url(#shSoft)"/>
  ...
  <text x="160" y="612" font-size="10.5" fill="#555">教員1人あたりの</text>
  <text x="160" y="628" font-size="10.5" fill="#555">研究時間を確保</text>
  <rect x="371" y="592" width="308" height="54" rx="10" fill="#ffffff" filter="url(#shSoft)"/>
  <rect x="371" y="592" width="5" height="54" rx="2.5" fill="url(#gWarn)"/>
  <text x="389" y="630" font-size="28" font-weight="700" fill="#c4632a">+30<tspan font-size="13" font-weight="400">%</tspan></text>
  <text x="491" y="612" font-size="10.5" fill="#555">高度化に使える時間の増加</text>
  <text x="491" y="628" font-size="10.5" fill="#555">定型問合せ・窓口業務の削減</text>
  <rect x="702" y="592" width="308" height="54" rx="10" fill="#ffffff" filter="url(#shSoft)"/>
  <rect x="702" y="592" width="5" height="54" rx="2.5" fill="url(#gAccH)"/>
  <text x="720" y="630" font-size="28" font-weight="700" fill="#16624b">＋10<tspan font-size="13" font-weight="400">pt</tspan></text>
  <text x="822" y="612" font-size="10.5" fill="#555">院生の研究力</text>
  <text x="822" y="628" font-size="10.5" fill="#555">（自己効力感） ※期待値</text>
  <rect x="1032" y="592" width="208" height="54" rx="10" fill="#ffffff" filter="url(#shSoft)"/>
  <rect x="1032" y="592" width="5" height="54" rx="2.5" fill="url(#gGoal)"/>
  <text x="1048" y="630" font-size="28" font-weight="700" fill="#1c6e44">＋5<tspan font-size="13" font-weight="400">pt</tspan></text>
  <text x="1118" y="612" font-size="8.8" fill="#555">レピュテーションの向上</text>
  <text x="1118" y="628" font-size="8.8" fill="#555">大学UXの変革</text>
  <rect x="40" y="648" width="308" height="16" rx="4" fill="#1b6ca8"/>
  <text x="194" y="656" font-size="9.5" font-weight="700" fill="#ffffff" text-anchor="middle" dominant-baseline="central">大学全体の研究高度化</text>
  <rect x="371" y="648" width="308" height="16" rx="4" fill="#b84d5b"/>
  <text x="525" y="656" font-size="9.5" font-weight="700" fill="#ffffff" text-anchor="middle" dominant-baseline="central">Cut by DXの支援</text>
  <rect x="702" y="648" width="308" height="16" rx="4" fill="#2e9684"/>
  <text x="856" y="656" font-size="9.5" font-weight="700" fill="#ffffff" text-anchor="middle" dominant-baseline="central">Ai時代の創造的人材の育成</text>
  <rect x="40" y="668" width="1200" height="36" rx="10" fill="#eaf1fb"/>
  <rect x="40" y="668" width="6" height="36" rx="3" fill="url(#gBlue)"/>
  <circle cx="70" cy="686" r="8" fill="#dceaf8"/>
  <text x="70" y="686" font-size="10" font-weight="700" fill="#2a5d96" text-anchor="middle" dominant-baseline="central">1</text>
  <text x="84" y="680" font-size="9.5" font-weight="700" fill="#1f2937">許諾済データの共有・利活用</text>
  <text x="84" y="692" font-size="8" fill="#555">個人情報を削除し、学内・行政・企業の共同研究で</text>
  <circle cx="476" cy="686" r="8" fill="#dceaf8"/>
  <text x="476" y="686" font-size="10" font-weight="700" fill="#2a5d96" text-anchor="middle" dominant-baseline="central">2</text>
  <text x="490" y="680" font-size="9.5" font-weight="700" fill="#1f2937">AI企業と組んでノウハウ・アプリを販売</text>
  <text x="490" y="692" font-size="8" fill="#555">蓄積した実践知・基盤を外部へ展開</text>
  <circle cx="836" cy="686" r="8" fill="#dceaf8"/>
  <text x="836" y="686" font-size="10" font-weight="700" fill="#2a5d96" text-anchor="middle" dominant-baseline="central">3</text>
  <text x="850" y="680" font-size="9.5" font-weight="700" fill="#1f2937">経営判断に資する情報提供が迅速化</text>
  <text x="850" y="692" font-size="8" fill="#555">データの統合・分析が容易に</text>
</svg>
