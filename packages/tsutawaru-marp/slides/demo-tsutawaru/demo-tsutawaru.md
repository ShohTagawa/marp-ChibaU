...
paginate: true
size: 16:9
header: '<div class="hdr-left">伝わるデザインの基本 準拠テーマ</div><img class="hdr-logo" src="../assets/logo-placeholder.png" alt="LOGO">'
footer: ''
---
...
<div class="title-photo">写真（差し替え）</div>
<div class="title-meta">
<div class="title-event">『伝わるデザインの基本 増補改訂3版』準拠</div>
<div class="title-date">発表日</div>
<div>所属・発表者名</div>
</div>
</div>
...
<div class="meta">発表日　所属・発表者名</div>
...
<div class="datarow"><span>推敲済みの4デック</span><span class="v"><span class="num">0.32</span><span class="unit">枠/枚</span></span></div>
...
<div class="datarow"><span>推敲済みの4デック</span><span class="v"><span class="num">218</span><span class="unit">字</span></span></div>

</div>
</div>

<p class="note wide">著者の運用リポジトリ（139デック・3,688枚）の機械集計。<b>差が出たのは囲みの数であって、文字数ではない。</b></p>
...
<div class="cap">月別の囲み密度（著者リポジトリの実測）</div>
...
<div class="t">ルールの運用を始めた6月に急減</div>
