...
- AIの**性能は指数関数的**、**活用は線形**——使ってみて、ギャップを埋めよう
- Gemini基本編：**14のユースケース**を眺めた
- Copilotは作成（Stories）と指導（教育ツール）の筋が良い
- NotebookLMで**資料群と対話**できる（＋共有で組織の情報活用に貢献）
- Gems・iPaaS・CLIで**自分専用のAI**を組み立てることができる
- 学び方は**OODAループ**的→まずは、使ってみること、評価することが大切
