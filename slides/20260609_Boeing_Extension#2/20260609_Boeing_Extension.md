...
- 協力的な場づくり／<b>言い合える文化</b>を大切に
- <b>敬意</b>を持って、<b>忌憚なく</b>、<b>建設的に</b>
- 自主的に進める（各チームでスケジュール管理）
- 「手を差し伸べる」より <b>「助けを相談する」</b>
...
- 役職に関係なく <b>気づきを声に出す</b>（CRM）
- 失敗を責めず <b>学びに変える</b>（Just Culture）
- <b>安全第一・無理をしない</b>（疲れたら休む）
- <b>時間を守る</b>（定時運航のように締切・集合）
