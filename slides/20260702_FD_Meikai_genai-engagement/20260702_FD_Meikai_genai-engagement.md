...
<div class="infer-l">
<div class="infer-step">① 次の一語を<b>確率で選ぶ</b></div>
...
<div class="cmp">
<div class="cmp-col">
<div class="cmp-h">⚠ 入れてはいけない情報（例）</div>
...
<div class="takeaway">問えるのは「使ったか」より「"なぜ今は使わないか"を、自分の言葉にできるか」</div>
...
<div class="caption">生成物を<b>そのまま自分の成果</b>として出すのは、この誠実さに反する ── 成績・成果は、学生自身の力
