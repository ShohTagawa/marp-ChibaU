...
<text x="26" y="234" font-size="18" fill="#5F5F5F">保護者は入試の情報も気になるはず。一文だけ添える。</text>
...
- **「少し待つと賢くなる」と覚えると得をします**
  急ぎの下書きと、じっくりの検討で使い分けられます。
...
## 私たちが触っているのは、学習ではなく推論の側です

<style scoped>
  /* 3段のうち「推論」だけを強調する。枠の太さ・色・小見出しの大きさは下の数字で変わる */
  section .flow { margin: .35em 0 .6em; }   /* 「ここ」の1行が増えた分、上下を詰める */
  section .flow > .fbox.now { border-width: 3px; border-color: var(--accent); background: var(--accent-soft); }
  section .flow > .fbox.now .big { color: var(--accent-dark); }
  section .flow > .fbox.now .here {
    display: block; margin-top: .12em; font-size: .82em; font-weight: 700; color: var(--accent-dark);
  }
  /* 前後の2つは一段引く（強調は1か所だけにする） */
  section .flow > .fbox:not(.now) { color: #6B6B6B; border-color: #B0B0B0; }
</style>

<div class="body">

<div class="flow">
<div class="fbox">学習<span class="big">重みを育てる</span></div>
<div class="arw"></div>
<div class="fbox now">推論<span class="big">重みで答える</span><span class="here">私たちが触るのはここ</span></div>
<div class="arw"></div>
<div class="fbox">アプリ<span class="big">見せて対話する</span></div>
</div>
...
- **アプリ：モデルを直接ではなく、囲って使います**
  渡す情報を絞り、確認を挟む。この「回し方」がハーネスです。

</div>

<div class="takeaway">学習と推論の癖を、アプリ側の工夫で補うのが今日の話です</div>


<!-- 学習・推論・アプリの3段で、この後の伏線を2つ置く。①学習にはデータが要る＝入力が改善に使われ人が見ることがある（→「危険性①」で設定の話に回収）。②推論は重みだけで続きを作る＝ハルシネーション（→「危険性②」）。③だからモデルを裸で使わず、アプリ＝ハーネスで囲う（前ページの続き）。 -->

---

<div class="page-title">生成AIの種類</div>

## ひとくちに生成AIと言っても、4つの型があります
...
<!-- 分類は入れ子にしない。次の「危険性」への橋渡し。 -->

---

<div class="page-title">危険性 ①　情報の流出</div>
...
<div class="page-title">危険性 ②　認知的負債</div>

## 任せきりにすると、考える力が細っていきます
...
<p class="note wide">Bastani et al. (2025)「Generative AI without guardrails can harm learning」<i>PNAS</i> 122(26): e2422633122。トルコの高校9〜11年生 約1,000名を対象とした無作為化実験（査読済み）。2023年秋・GPT-4での結果です。</p>
...
<div class="page-title">危険性 ③　シャドーAI</div>
...
<div class="grid2">
<div class="fill">
<div class="t">学生名簿を貼って並べ替える</div>
<div class="d">個人契約のAIに、名簿をそのまま貼る。</div>
</div>
<div class="fill">
<div class="t">面談の記録を要約させる</div>
<div class="d">学生や保護者とのメモを無料AIに貼る。</div>
</div>
<div class="fill">
<div class="t">未公開の資料を下書きさせる</div>
<div class="d">入試・人事・理事会の資料を読ませる。</div>
</div>
<div class="fill">
<div class="t">素性の分からないアプリを使う</div>
<div class="d">私物スマホの翻訳アプリに業務文を通す。</div>
</div>
</div>

- **どれも悪気はありません。だから見えなくなります**
  組織が把握できない利用が「シャドーAI」です。禁止するより、安全に使える道を用意するほうが効きます。

</div>

<div class="takeaway">迷ったら「この情報を外部に出せるか」で判断してください</div>

<!-- シャドーAI。責める話ではなく、組織で道を作る話につなげる。4つの例は「うちでも起きうる」と自分の部署に置き換えてもらう。 -->

---

<div class="page-title">危険性 ④　著作権</div>

## 著作権は、「学習」と「生成」を分けて考えます
...
- **学習段階：日本では、原則として許諾なく学習に使えます**
  著作権法30条の4。ただし条件と例外があります。
- **生成段階：出力が既存の作品に似ていれば、侵害になり得ます**
  「AIが作ったから安全」にはなりません。
- **生成物を公開・配布するときは、人が作った場合と同じ基準で確かめます**
  既存作品との類似と依拠が、判断の軸になります。

</div>
</div>

<!-- 広報物にAI画像を使う場面が増えるので、職員にも直結する話。 -->
...
<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" baseProfile="full" viewBox="0 0 760 400"><rect width="760" height="400" x="0" y="0" fill="none"></rect><path d="M254.5 10L254.5 364" fill="none" pointer-events="visible" stroke="#E4E4E4" class="zr0-cls-0"></path><path d="M339.5 10L339.5 364" fill="none" pointer-events="visible" stroke="#E4E4E4" class="zr0-cls-0"></path><path d="M425.5 10L425.5 364" fill="none" pointer-events="visible" stroke="#E4E4E4" class="zr0-cls-0"></path><path d="M511.5 10L511.5 364" fill="none" pointer-events="visible" stroke="#E4E4E4" class="zr0-cls-0"></path><path d="M596.5 10L596.5 364" fill="none" pointer-events="visible" stroke="#E4E4E4" class="zr0-cls-0"></path><path d="M682.5 10L682.5 364" fill="none" pointer-events="visible" stroke="#E4E4E4" class="zr0-cls-0"></path><path d="M254 10L254 364" fill="none" pointer-events="visible" stroke="#262626" stroke-width="1.5" stroke-linecap="round" class="zr0-cls-0"></path><path d="M-208 -11.5l208.1 0l0 23l-208 0Z" transform="translate(244 39.5)" fill="none" pointer-events="visible" class="zr0-cls-0"></path><text dominant-baseline="central" text-anchor="end" style="font-size:19px;font-family:'BIZ UDPGothic','Hiragino Sans','Hiragino Kaku Gothic ProN','Yu Gothic Medium','Noto Sans JP',Meiryo,sans-serif;font-weight:bold;" transform="translate(244 39.5)" fill="#262626">カリキュラムへのAI統合</text><path d="M-208 -11.5l208.1 0l0 23l-208 0Z" transform="translate(244 98.5)" fill="none" pointer-events="visible" class="zr0-cls-0"></path><text dominant-baseline="central" text-anchor="end" style="font-size:19px;font-family:'BIZ UDPGothic','Hiragino Sans','Hiragino Kaku Gothic ProN','Yu Gothic Medium','Noto Sans JP',Meiryo,sans-serif;font-weight:bold;" transform="translate(244 98.5)" fill="#262626">学生のAIリテラシー育成</text><path d="M-228 -23l228 0l0 46l-228 0Z" transform="translate(244 157.5)" fill="none" pointer-events="visible" class="zr0-cls-0"></path><text dominant-baseline="central" text-anchor="end" style="font-size:19px;font-family:'BIZ UDPGothic','Hiragino Sans','Hiragino Kaku Gothic ProN','Yu Gothic Medium','Noto Sans JP',Meiryo,sans-serif;font-weight:bold;" y="-11.5" transform="translate(244 157.5)" fill="#262626">ガバナンス・ポリシーの確</text><text dominant-baseline="central" text-anchor="end" style="font-size:19px;font-family:'BIZ UDPGothic','Hiragino Sans','Hiragino Kaku Gothic ProN','Yu Gothic Medium','Noto Sans JP',Meiryo,sans-serif;font-weight:bold;" y="11.5" transform="translate(244 157.5)" fill="#262626">立</text><path d="M-113 -11.5l113.1 0l0 23l-113 0Z" transform="translate(244 216.5)" fill="none" pointer-events="visible" class="zr0-cls-0"></path><text dominant-baseline="central" text-anchor="end" style="font-size:19px;font-family:'BIZ UDPGothic','Hiragino Sans','Hiragino Kaku Gothic ProN','Yu Gothic Medium','Noto Sans JP',Meiryo,sans-serif;font-weight:bold;" transform="translate(244 216.5)" fill="#262626">AI技術の実装</text><path d="M-196.3 -11.5l196.3 0l0 23l-196.3 0Z" transform="translate(244 275.5)" fill="none" pointer-events="visible" class="zr0-cls-0"></path><text dominant-baseline="central" text-anchor="end" style="font-size:19px;font-family:'BIZ UDPGothic','Hiragino Sans','Hiragino Kaku Gothic ProN','Yu Gothic Medium','Noto Sans JP',Meiryo,sans-serif;font-weight:bold;" transform="translate(244 275.5)" fill="#262626">教員研修（FD）の加速</text><path d="M-228 -23l228 0l0 46l-228 0Z" transform="translate(244 334.5)" fill="none" pointer-events="visible" class="zr0-cls-0"></path><text dominant-baseline="central" text-anchor="end" style="font-size:19px;font-family:'BIZ UDPGothic','Hiragino Sans','Hiragino Kaku Gothic ProN','Yu Gothic Medium','Noto Sans JP',Meiryo,sans-serif;font-weight:bold;" y="-11.5" transform="translate(244 334.5)" fill="#262626">運営・管理の効率化（最下</text><text dominant-baseline="central" text-anchor="end" style="font-size:19px;font-family:'BIZ UDPGothic','Hiragino Sans','Hiragino Kaku Gothic ProN','Yu Gothic Medium','Noto Sans JP',Meiryo,sans-serif;font-weight:bold;" y="11.5" transform="translate(244 334.5)" fill="#262626">位）</text><text dominant-baseline="central" text-anchor="middle" style="font-size:16px;font-family:'BIZ UDPGothic','Hiragino Sans','Hiragino Kaku Gothic ProN','Yu Gothic Medium','Noto Sans JP',Meiryo,sans-serif;" y="8" transform="translate(254 374)" fill="#5F5F5F">0%</text><text dominant-baseline="central" text-anchor="middle" style="font-size:16px;font-family:'BIZ UDPGothic','Hiragino Sans','Hiragino Kaku Gothic ProN','Yu Gothic Medium','Noto Sans JP',Meiryo,sans-serif;" y="8" transform="translate(339.6 374)" fill="#5F5F5F">20%</text><text dominant-baseline="central" text-anchor="middle" style="font-size:16px;font-family:'BIZ UDPGothic','Hiragino Sans','Hiragino Kaku Gothic ProN','Yu Gothic Medium','Noto Sans JP',Meiryo,sans-serif;" y="8" transform="translate(425.2 374)" fill="#5F5F5F">40%</text><text dominant-baseline="central" text-anchor="middle" style="font-size:16px;font-family:'BIZ UDPGothic','Hiragino Sans','Hiragino Kaku Gothic ProN','Yu Gothic Medium','Noto Sans JP',Meiryo,sans-serif;" y="8" transform="translate(510.8 374)" fill="#5F5F5F">60%</text><text dominant-baseline="central" text-anchor="middle" style="font-size:16px;font-family:'BIZ UDPGothic','Hiragino Sans','Hiragino Kaku Gothic ProN','Yu Gothic Medium','Noto Sans JP',Meiryo,sans-serif;" y="8" transform="translate(596.4 374)" fill="#5F5F5F">80%</text><text dominant-baseline="central" text-anchor="middle" style="font-size:16px;font-family:'BIZ UDPGothic','Hiragino Sans','Hiragino Kaku Gothic ProN','Yu Gothic Medium','Noto Sans JP',Meiryo,sans-serif;" y="8" transform="translate(682 374)" fill="#5F5F5F">100%</text><path d="M254 24.2l282.9 0l0 30.7l-282.9 0Z" fill="#2F6B3A" ecmeta_series_index="0" ecmeta_data_index="0" ecmeta_ssr_type="chart" class="zr0-cls-1"></path><path d="M254 83.2l252.9 0l0 30.7l-252.9 0Z" fill="#2F6B3A" ecmeta_series_index="0" ecmeta_data_index="1" ecmeta_ssr_type="chart" class="zr0-cls-1"></path><path d="M254 142.2l248.7 0l0 30.7l-248.7 0Z" fill="#2F6B3A" ecmeta_series_index="0" ecmeta_data_index="2" ecmeta_ssr_type="chart" class="zr0-cls-1"></path><path d="M254 201.2l239.3 0l0 30.7l-239.3 0Z" fill="#2F6B3A" ecmeta_series_index="0" ecmeta_data_index="3" ecmeta_ssr_type="chart" class="zr0-cls-1"></path><path d="M254 260.2l216.1 0l0 30.7l-216.1 0Z" fill="#2F6B3A" ecmeta_series_index="0" ecmeta_data_index="4" ecmeta_ssr_type="chart" class="zr0-cls-1"></path><path d="M254 319.2l6.8 0l0 30.7l-6.8 0Z" fill="#BDBDBD" ecmeta_series_index="0" ecmeta_data_index="5" ecmeta_ssr_type="chart" class="zr0-cls-2"></path><text dominant-baseline="central" text-anchor="start" style="font-size:21px;font-family:'BIZ UDPGothic','Hiragino Sans','Hiragino Kaku Gothic ProN','Yu Gothic Medium','Noto Sans JP',Meiryo,sans-serif;font-weight:bold;" transform="translate(541.908 39.5)" fill="#262626">66.1%</text><text dominant-baseline="central" text-anchor="start" style="font-size:21px;font-family:'BIZ UDPGothic','Hiragino Sans','Hiragino Kaku Gothic ProN','Yu Gothic Medium','Noto Sans JP',Meiryo,sans-serif;font-weight:bold;" transform="translate(511.948 98.5)" fill="#262626">59.1%</text><text dominant-baseline="central" text-anchor="start" style="font-size:21px;font-family:'BIZ UDPGothic','Hiragino Sans','Hiragino Kaku Gothic ProN','Yu Gothic Medium','Noto Sans JP',Meiryo,sans-serif;font-weight:bold;" transform="translate(507.668 157.5)" fill="#262626">58.1%</text><text dominant-baseline="central" text-anchor="start" style="font-size:21px;font-family:'BIZ UDPGothic','Hiragino Sans','Hiragino Kaku Gothic ProN','Yu Gothic Medium','Noto Sans JP',Meiryo,sans-serif;font-weight:bold;" transform="translate(498.252 216.5)" fill="#262626">55.9%</text><text dominant-baseline="central" text-anchor="start" style="font-size:21px;font-family:'BIZ UDPGothic','Hiragino Sans','Hiragino Kaku Gothic ProN','Yu Gothic Medium','Noto Sans JP',Meiryo,sans-serif;font-weight:bold;" transform="translate(475.14 275.5)" fill="#262626">50.5%</text><text dominant-baseline="central" text-anchor="start" style="font-size:21px;font-family:'BIZ UDPGothic','Hiragino Sans','Hiragino Kaku Gothic ProN','Yu Gothic Medium','Noto Sans JP',Meiryo,sans-serif;font-weight:bold;" transform="translate(265.848 334.5)" fill="#262626">1.6%</text><style ><![CDATA[.zr0-cls-0:hover {pointer-events:none;}.zr0-cls-1:hover {cursor:pointer;fill:rgba(51,117,63,1);}.zr0-cls-2:hover {cursor:pointer;fill:rgba(207,207,207,1);}]]></style></svg>

<div class="cap">1年間で取り組みたいこと（上位5項目と最下位／全10項目）</div>
<div class="cite">Bowen &amp; Watson (2025)／AAC&amp;U「2025–2026年度 AI・教育法・カリキュラムに関するインスティテュート」参加大学調査（n=191・上位3〜5項目を選択）</div>
