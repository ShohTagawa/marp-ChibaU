...
paginate: true
size: 16:9
header: '<div class="hdr-left">生成AIの活用法について</div><img class="hdr-logo" src="./src/uekusa-logo.png" alt="植草学園大学"><span class="hdr-tag">全学AI<br>SD研修</span>'
footer: ''
style: |
  ...
  /* ── 投影可読性：本文を一回り大きく（テーマ既定23px→26px） ── */
  section { font-size: 26px; }
  section table { font-size: 23px; }
  /* ── 右上ロゴの右の二段ラベル ── */
  section > header .hdr-logo { margin-right: 10px; }
  section > header .hdr-tag {
    align-self: center; margin-right: 24px;
    font-size: 15px; font-weight: 700; line-height: 1.3;
    color: var(--accent-dark); text-align: center; letter-spacing: .05em;
  }
  ...
  /* 具体例・補足の囲み（グレー地）。主張は箇条書き、具体例はこの枠に分離する。
     使い方: <div class="ex">例：…</div> */
  .ex {
    background: #F4F4F2; border-radius: 4px;
    padding: .55em .95em; margin: .5em 0 0;
    font-size: 21px; color: #5F5F5F; line-height: 1.65;
  }
  .ex b { color: #3d3d3d; }
  /* ── Slido設問スライド共通 ─────────────────────────────
...
<!--
軽量版フォーク（元: 20260820_SD_Uekusa_genai-usage）。元82枚から仕組み深掘り・レーダー・人間中心原則・研究ルール・展望などを削除して再構成。本文26px・主張＋具体例(.ex)の2層構造。
確定済み: Slido = コード uekusa-ai26 / https://app.sli.do/event/wZgLG7PtvyyqKiE5iGjvdD / QR=src/slido-qr.png
確定済み: 提出先スライド・Driveフォルダ・OneDrive のURLは「提出と共有」スライドに記載。
-->
...
<!--
【原稿｜開場】
（開場中は表紙のまま。8時55分になったら次のSlido案内へ切り替える。無言でよい）

【メモ】開場中はこの表紙を投影。8:55からS2のSlido案内に切り替える。
-->
...
<div class="box-info"><b>Slidoとは</b>　スマホやPCから匿名で回答できるWebサービスです。登録は不要です。</div>
...
- **PCの方は、slido.com から参加できます**
  <a href="https://app.sli.do/event/wZgLG7PtvyyqKiE5iGjvdD">直リンク</a> or 参加コード uekusa-ai26
...
<div class="takeaway">本日はSlidoで伺いながら進めます。まずは「今日の期待」をご記入ください！</div>

<!--
【原稿｜1分】
おはようございます。始める前に、お手元のスマートフォンかパソコンでSlidoを開いてください。Slidoは、匿名で回答できるアンケートのサイトです。登録は要りません。
スマートフォンの方は、右のQRコードを読み取ってください。パソコンの方は、slido.com を開いて、参加コード uekusa-ai26 と入力してください。
回答は匿名です。お名前は出ません。ただし、個人情報や学内の機密は書かないでください。
今日はこのSlidoで、皆さんに何度か伺いながら進めます。

【メモ】8:55から投影。接続できない方には近くの方と画面共有をお願いする。9:00になったら理事長挨拶へ。
-->
...
<!--
【原稿｜挨拶中】
（この画面のまま、理事長のご挨拶。終わったら次へ）

【メモ】理事長挨拶の間はこの画面。挨拶が終わったら次へ。
-->
...
<div class="d">地球の内部を実験で<br>調べていました。</div>
...
<div class="d">現場のオペレーションと<br>改善を経験しました。</div>
...
<div class="d">AIを教育に生かす<br>仕事をしています。</div>
...
<div class="takeaway">千葉大学で、教職協働のもと、AIの活用を広げています。</div>

<!--
【原稿｜1分】
あらためまして、千葉大学の田川翔です。国際未来教育基幹、高等教育センターで助教をしています。
経歴を3つだけ。左が理学です。地球の内部を実験で調べる研究をしていました。真ん中が民間です。航空貨物の会社で、現場のオペレーションと業務改善を経験しました。右がいまの仕事です。大学教育の現場で、AIをどう使うかを扱っています。
研究者というより、現場で手を動かしてきた人間です。今日は千葉大学で教員と職員が一緒にやっている取り組みを、そのままお伝えします。

【メモ】理事長挨拶のあと、ここから講師パート。名乗りと経歴を1枚にまとめてある（旧・表紙再掲は廃止）。30秒〜1分。経歴の詳細より「現場出身」であることを伝える。
-->
...
<div class="takeaway">千葉大の実践からもお話します！</div>

<!--
【原稿｜30秒】
いまは千葉大学の図書館を拠点に、学生と教職員向けの生成AI講座を続けています。
上が15分セッションの第4回で、大学のアカウントで毎日の定型作業をAIに任せる回です。下があかりんアワーで、昼休みの30分に、使える機能をまとめて紹介しました。4月から7月で全6回、対面とオンラインの選択制です。
今日お話しするのは、ここで実際に試して反応がよかったものが中心です。

【メモ】30秒。実績の自慢ではなく「同じことを現場で試している人間が話す」という位置づけを伝える。15分×3（講義→体験→座談）の形式が好評だったことにも一言触れる。
-->
...
<div class="takeaway">生成AIと大学の関係に、当事者として関心を持っています。</div>

<!--
【原稿｜1分】
なぜAIに関心があるのか、正直にお話しします。
私は理学から民間、そして大学教育へと分野を移ってきました。移るたびにゼロから学び直しで、これが本当にしんどかった。だからAIを、学び直しの伴走者として見ています。
もう一つは出口から見たときの話です。卒業後の仕事を考えると、AIは非常に優れた道具です。もっと学べて、みんなが幸せな大学をAIで作りたい。
右の本は、いま私が訳している『AI時代の大学教育』です。近く出ます。私自身が当事者として、生成AIと大学の関係に関心を持っています。

【メモ】1分。理学の博士を取ったのがコロナ禍と重なり、「大学自体が大変・学び方が変わる」という問題意識からオンライン教育支援の研究を始めた、という実話。分野を移るたびのゼロからの学び直しが本当にしんどかった、という実感を素直に語る。ここが後半の「使えないこともAIに聞ける」に効いてくる。
-->
...
| 時間 | すること |
|---|---|
| 9:05 – 9:25 | 前半1：生成AIの仕組みを知る |
| 9:30 – 9:50 | 前半2：大学とAIの関わりを考える |
| 10:00 – 10:15 | 後半1：道具ごとの得意技を知る |
| 10:15 – 11:20 | 後半2：**グループワーク＆ミニコンペ**で実際に試す |
| 11:20 – 11:35 | 共有、まとめ、振り返り |

<p class="note wide">途中に3分程度と10分の休憩を挟みます。</p>

</div>
<div class="takeaway">ゴールは「AIを使えたという達成感」と「AIとの関わり方について意見を持つ」ことです。</div>


<!--
【原稿｜30秒】
今日の流れです。
前半の1つ目、9時5分から25分までが生成AIの仕組み。前半の2つ目、9時30分から50分までが大学とAIの関わりです。10時から15分間で道具の得意技を紹介して、そのあと11時20分まで、グループで実際に手を動かします。最後に共有とまとめです。途中に短い休憩と、10分の休憩を挟みます。
今日のゴールは2つです。AIを使えたという達成感と、AIとどう付き合うかについて自分の意見を持って帰ることです。

【メモ】時間割を30秒で。ワークがあること、移動があり得ることを予告する。
-->
...
<div class="takeaway">知る → 試す → 関わり方を言葉にする…と、大変な一日ですが、楽しんでいきましょう！</div>

<!--
【原稿｜30秒】
前半のねらいは3つです。
1つ目、生成AIの仕組みを知ること。確率で動く機械だと分かると、扱いやすくなります。2つ目、危ない使い方との線引きができるようになること。3つ目、自分の仕事で試す一歩目にすることです。
右の図のとおり、知る、試す、そして自分なりの関わり方を作る、という順で進みます。
もう一つお願いがあります。今日は、一緒に活用を進められる仲間を見つけてください。

【メモ】「〇〇できるようになる」を具体的に3つ宣言する。
-->
...
<div class="chapter-num">前半1 ｜ 9:05 – 9:25</div>
...
<!--
【原稿｜30秒】
ここから前半の1つ目です。生成AIとは何か。
仕組みが分かれば、怖さは減ります。まず、皆さんの現在地を伺わせてください。

【メモ】章扉。ここからSlidoアンケート1へ。
-->
...
- **1-①　生成AIをどのくらいの頻度で使用されていますか？<span class="qtag">択一</span>**
  毎日 ／ 週に数回 ／ 月に数回 ／ 使ったことがない
- **1-②　生成AIを何に使っていますか<span class="qtag">複数選択</span>**
  文章の下書き ／ 調べもの ／ 翻訳 ／ 資料づくり ／ その他 ／ まだ使っていない
- **1-③　教育や大学業務において、<br>AIにどんな印象をもっていらっしゃいますか？<span class="qtag">択一</span>**
...
<!--
【原稿｜3分】
Slidoを開いてください。3問伺います。
1問目、生成AIをどのくらいの頻度で使っていますか。2問目、生成AIを何に使っていますか。これは複数選べます。3問目、教育や大学業務において、AIにどんな印象をお持ちですか。
正解はありません。いまの実感のままお答えください。
（回答を2分待つ。結果を映して分布を一言ずつ拾う。3問目は最後にもう一度伺うことだけ伝える）

【メモ】【ここで Slido 1-①〜③ を実施】結果を画面に映し、分布を一言ずつ拾う。1-③の結果は最後（5-①）ともう一度比べる、と予告する。
-->
...
- **日本企業は<span class="ss-tune" style="color:#7d1322 !important">55.2%しか</span>使っていません**
  米国・ドイツ・中国は9割を超えています。

<div class="ex">特に、個人の利用と組織としての利用は、<b>フェーズが異なります</b>。いまは、得意な個人が、自分の業務を最大化するイメージです(今日の研修も)。<br>
でも、「議事録が常に短時間で作成され保存される」「チームの過去の知見を検索できる」「AIツールを他の人に配れる」とか組織的にワークフローまで自動化できると最高ですよね！</div>

</div>
</div>

<div class="takeaway">日本は、組織での生成AIの活用が、これからです。</div>

<!--
【原稿｜45秒】
仕事で生成AIを使う流れは来ています。ただ、日本はまだ半分です。
左のグラフをご覧ください。業務で生成AIを一つでも使っている企業の割合は、日本が55.2%。米国、ドイツ、中国は9割を超えています。総務省の情報通信白書の数字です。
ここで大事なのは、個人が使うことと、組織として使うことは段階が違うという点です。いまは、得意な人が自分の仕事を効率化している段階です。今日の研修もそこを狙っています。
この先、議事録が自動で残る、過去の知見を検索できる、作った道具を配れる。そこまで進むと、組織として効いてきます。

【メモ】業務側の現在地。海外との差を煽らず「伸びしろ」として置く。数値の出典＝業務利用は図表Ⅰ-1-2-14「企業における業務での生成AI利用率（国別）」、活用方針は図表Ⅰ-1-2-12「生成AIの活用方針策定状況（国別）」（積極的23.7%＋領域限定26.0%＝49.7%、方針を定めていない31.8%）、個人利用は「生成AIサービス利用経験（国別／年代別、日本）」。
-->
...
- **学生の92.2%が、使った経験があります**
  2年で倍増し、用途は授業が中心です。

<div class="box-accent">学校・保育でも資料づくりや業務での活用が進むはずです。卒業後も機会は多いでしょう。<br>膨大な資料の解釈など、いままでやりたかったけど時間/ノウハウがなかったことを実現する道具になります。</div>

</div>
</div>

<div class="takeaway">AIはすでに環境に → 禁止ではなく、使い方を設計し、人の幸せと成長に繋げる段階です</div>

<!--
【原稿｜45秒】
一方で、目の前の学生はもうほぼ全員が使っています。
左のグラフです。生成AIを使った経験があると答えた大学生は、2023年に46.7%、2024年に68.2%、2025年には92.2%。2年で倍になりました。全国大学生活協同組合連合会の学生生活実態調査です。用途は授業が中心です。
学校や保育の現場でも、資料づくりや業務での活用は進んでいきます。卒業後にAIに触れる機会は多い。
つまりAIは、すでに環境の一部です。禁止するかどうかではなく、どう使わせるかを設計する段階に来ています。

【メモ】学生側の現在地。9割超という数字を、驚きではなく前提として置く。用途が学修の中心に入っている点を強調する。
-->
...
<div class="srcline">出典: Massenkoff &amp; McCrory (2026)「Labor market impacts of AI」</div>
...
【原稿｜45秒】
AIが得意な仕事と、人が担い続けそうな仕事があります。
右の図は、職種ごとにAIができる範囲を示したものです。青が、AIが理論上できる範囲。事務や書類の仕事ほど、青が広がります。赤が、実際に使われている範囲です。この青と赤の差が、これからの伸びしろにあたります。
緑の文字で示した3つ、教育・図書、対人ケア、事務・管理が、皆さんの仕事に近い領域です。人やケアに関わる仕事ほど、AIができる範囲は狭いままです。
分野によって差が大きいこと、事務作業には余地が大きいこと、ケアの価値は変わらないこと。この3点を押さえてください。

【メモ】明海FDから移設し、強調軸を学園向けに変更。青と赤の面積差を指さして見せる。赤い3軸（教育・図書／対人ケア／事務・管理）が皆さんの仕事、と伝えてから、次の業務の話につなぐ。数値は公開図からの読み取りである点に注意。
-->
...
- **AIを活用するためのデータがありません**
  AIが大学・企業のデータを活用しようにも、読めない場合が多く、まずはそこからです。

</div>
</div>

<div class="takeaway">焦る必要はありません。トップで指針・道具を整備、ボトムアップで試行錯誤と一歩ずつ！</div>

<!--
【原稿｜45秒】
AIの性能は伸びましたが、現場での活用は追いついていません。
左の図で、曲線がモデルの性能、直線が組織の活用です。性能は毎年大きく伸びる一方、使い方は緩やかにしか変わりません。この差を Capability Overhang、性能の余りと呼びます。
理由がもう一つあります。AIに渡せるデータが揃っていないことです。大学や企業のデータは、紙のままだったり、AIが読めない形だったりします。
ですから焦る必要はありません。上は指針と道具を整え、現場は小さく試す。この両方を一歩ずつ進めます。

【メモ】性能ギャップの話。去年の印象で判断しない、が要点。
-->
...
- **はじまりは、一問一答のチャットでした**
- **次に、AIが外の道具(Web検索/ファイル読み込み)を使えるようになりました**
...
【原稿｜45秒】
AIとの関わり方は変わってきています。
上の帯を左から見てください。はじまりは、聞くと答えが返るチャットでした。次に、AIがWeb検索やファイルの読み込みといった外の道具を使えるようになりました。そしていまは、目的を渡すと自分で手順を立てて進めます。これをエージェントと呼びます。
調べて、まとめて、下書きまでが一続きになり、人は途中の確認と最後の判断を担います。任せられる範囲が広がっている、ということです。

【メモ】未来といっても数年先ではなく、すでに始まっている変化だと伝える。「どこまで任せるか」の線引きは後半の使い分けで扱う、と予告する。
-->


---

<div class="page-title">自動化の例</div>
...
<div class="takeaway">「定型で、面倒で、時間のかかっている作業」こそ、AIに任せる第一候補です</div>


<!--
【原稿｜45秒】
毎回やっている作業は、言葉で頼むだけで自動化できます。
左の表をご覧ください。名簿の表記ゆれを直す。問い合わせに定型で返す。自由記述を読んで分類する。報告書の体裁を揃える。どれも、数十件をまとめて処理できます。
右の図が手順です。まず言葉で頼む。次にAIが手順を作って実行し、人はできあがりを確かめる。三段目、次からは同じ頼み方を使い回せます。同僚にもそのまま渡せます。
定型で、面倒で、時間のかかっている作業。これがAIに任せる第一候補です。

【メモ】実演気味に。「この資料もAIと作った」で身近さを出す。
-->
...
<div class="ex">一語ずつ「続き」を選ぶだけで、ルール集でも、文例集でもありません。<br>覚えた「事実」ではなく「傾向」で答えるので、<br>知らないことにも、それらしく答えてしまいます。</div>
...
<!--
【原稿｜45秒】
今日いちばん持ち帰っていただきたい話です。言語型の生成AIは、次に来そうな言葉を選び続けるシステムです。
左の図をご覧ください。「吾輩は」の次に来る語を、AIは候補ごとに確率で出します。読点が11.5%、「猫」が9.9%、「犬」が4.0%。この中から次の一語を選び、それをまた入力に足して、次の一語を選ぶ。これをひたすら繰り返しています。
ルール集でも、文例集でもありません。だから、それらしいけれど違う、が起きます。正しさではなく、流暢さを訓練しているからです。覚えた事実ではなく、覚えた傾向で答えます。
生成AIは、次の一語を当て続ける機械です。

【メモ】今日いちばん持ち帰ってほしい1枚その1。Slidoの4択クイズはここから出す。
-->
...
<!--
【原稿｜45秒】
中身はルール集ではなく、巨大な数字の塊です。
左の図の上段を見てください。人が書いたルール、たとえば「吾輩は」なら「猫」と出す、という表ではありません。正解の文章を大量に溜め込んだ文例集でもありません。
実際は下の緑の枠、学習で決まった膨大な数字です。この数字は重みと呼ばれ、実際には何十億個も並んでいます。学習とは、この数字を少しずつ直していく作業です。
ここから大事なことが一つ出てきます。答えの理由をたどるのが難しい、という点です。作った会社のエンジニアでも、なぜその答えになったかは読み切れません。

【メモ】ルールベースとの対比。「なぜその答えか」を説明しにくい理由もここにある。
-->
...
- **いきなり答えず、考えの途中を書き出します**
  reasoningと呼ばれます。一回ではなく、何度も回して精度を上げます。
- **途中を読めば、どこで話がずれたか分かります**
  読み手を取り違えていたら、そこだけ直して頼み直せます。
- **人に頼むように、指示しましょう**
  マニュアルを渡す時、どうしますか？十分な資料(Context)を渡すと精度が出ます。
...
<!--
【原稿｜45秒】
最近のAIは、答える前に考える時間を取ります。
左の画面をご覧ください。上が質問で、オープンキャンパスの案内文を作ってほしい、と頼んでいます。真ん中の点線の枠が思考プロセスです。読み手は高校2年生と保護者だから専門用語は避けよう、300字なら3点に絞ろう、と書き出しています。これを reasoning と呼びます。一回の計算ではなく、何度も回して精度を上げています。
ここが見えると、読み手を取り違えていた場合に、その部分だけ直して頼み直せます。
頼み方のコツは一つです。人に仕事を頼むときと同じで、十分な資料を渡すと精度が上がります。

【メモ】reasoningは1回の計算ではなく反復。技術的に正確に。図は応答画面の再現例（実物のスクショに差し替え可）。当日は実機で1つ動かして見せてもよい。最後の囲みはハーネス（harness）の話。用語を覚えてもらう必要はなく、「プロンプトの言い回しより、渡す材料と確認の置き方」と言い換えて話す。
-->


---

<div class="page-title">仕組みのまとめ</div>
...
## 私たちは、「AIをつくる」学習ではなく、「使うとき」の推論をしています
...
<!--
【原稿｜45秒】
私たちが触っているのは、AIをつくる部分ではありません。
上の図の左、グレーの箱が学習です。提供者が大量のデータで中の数字を育てます。ここで注意が一つ。入力した内容が、この学習に使われることがあります。
右の緑の箱が推論です。私たちが使うのはこちらで、育てた数字だけを頼りに続きを組み立てます。事実を調べ直しているわけではないので、それらしい間違いが混ざります。
その弱点を補うために、右側にあるような工夫、渡す情報を絞る、人が確かめる場所を決める、といったことをアプリの側でやっています。

【メモ】学習・推論・アプリの3段で、この後の伏線を2つ置く。①学習にはデータが要る＝入力が改善に使われ人が見ることがある（→「リスク①」で設定の話に回収）。②推論は重みだけで続きを作る＝ハルシネーション（→「リスク②」）。③だからモデルを裸で使わず、アプリ＝ハーネスで囲う（前ページの続き）。
-->
...
<div>
<div class="t">特化型</div>
<div class="d">画像生成・翻訳など、一つの仕事専用のAIです。</div>
</div>
...
<div class="d">ChatGPT・Geminiなど。何にでも使える汎用型です。</div>
</div>
...
<div class="d">WordやGmailの中で動きます。</div>
</div>
...
<div class="d">PCの中で完結し、データを外に出しません。</div>
</div>
...
【原稿｜45秒】
ひとくちに生成AIと言っても、大きく4つの型があります。
左上が特化型。画像生成や翻訳など、一つの仕事専用のAIです。右上がなんでも型。ChatGPTやGeminiで、何にでも使える汎用型です。左下が、道具に組み込まれた型。WordやGmailの中で動きます。右下が、手元で動く型。パソコンの中で完結して、データを外に出しません。
どの型を使っているかで、注意すべき点が変わります。とくに、データがどこへ行くかが変わります。

【メモ】分類は入れ子にしない。次の「リスク」への橋渡し。
-->
...
<text x="28" y="286" font-size="17" fill="#262626">許可するAIと記入できる機密をルール化しましょう。</text>
</svg>
...
- **分かれ目は、どのアカウントで入るかです**
  ...
  無償でも学習に使われません。
  Copilotも同様です。
  <span class="ss-tune" style="color:#7d1322 !important">個人アカウントは、機密を扱うには向きません。</span>

</div>
</div>

<div class="takeaway">使っている生成AIのライセンスを確認しましょう</div>

<!--
【原稿｜45秒】
入力した内容が守られるかどうかは、料金ではなく契約で決まります。
分かれ目は、どのアカウントで入っているかです。同じ画面でも、個人のGoogleアカウントなら消費者向けの規約、学園のアカウントなら教育機関向けの規約が適用されます。
貴学園のアカウントで入っていれば、無償のままでも入力が学習に使われることはありません。人が中身を確認することもありません。Copilotも同じ考え方です。逆に、個人アカウントは機密を扱うには向きません。
右の図の順で確かめてください。一つ、学園のアカウントで入っているか。二つ、個人アカウントなら学習利用の設定をオフにする。三つ、迷う情報はそもそも入れない。

【メモ】軸は「無料か有料か」ではなく「どのアカウントで入っているか」。同じ gemini.google.com でも、個人アカウントなら消費者向け規約、学園アカウントなら Workspace for Education の規約が適用される。出典：Google 公式ヘルプ「Gemini アプリは、エンタープライズ級のデータ保護を備えたコアサービスとして、すべての Education エディションで使用できます」「ライセンスなしの Education Fundamentals ユーザーの場合：チャットとアップロードされたファイルは、人間のレビュアーが確認することも、生成 AI モデルの改善に使用されることもありません」。設定画面は当日デモでもよい。口頭で足す：学園アカウントなら人間のレビューも入らないので、成績や研究の機密をどこまで入れてよいかは、組織として判断・許可できる範囲の話になる。
-->
...
<div class="d">個人契約のAIに貼ってしまった。</div>
</div>
<div class="fill">
<div class="t">面談の記録を要約させる</div>
<div class="d">文字起こしを、AIが学習していた。</div>
</div>
<div class="fill">
<div class="t">未公開の原稿をAIに読ませる</div>
<div class="d">査読中の論文は、入力が禁止だった。</div>
</div>
<div class="fill">
<div class="t">素性の分からないアプリを使う</div>
<div class="d">安全性を確かめないまま使われていた。</div>
</div>
</div>

- どれも悪気はありません。でも、個人情報や機密情報の流出になる危険性があります。
  組織に見えないまま使われるのが「シャドーAI」です。<span class="ss-tune" style="color:#A6192E !important">安全に使える道の準備</span>が大切です。

</div>

<div class="takeaway">「どの道具なら安全か」を、組織で示すことが第一歩です</div>

<!--
【原稿｜45秒】
職場に、見えないAI利用が生まれ始めています。
例を4つ挙げます。学生名簿やレポートを、個人契約のAIに貼って並べ替えてしまった。面談の記録を要約させたら、その文字起こしが学習に使われていた。査読中の未公開原稿を読ませたが、投稿先では入力が禁止されていた。素性の分からないアプリを、安全性を確かめないまま使っていた。
どれも悪気はありません。しかし、個人情報や機密の流出になり得ます。組織から見えないまま使われる状態を、シャドーAIと呼びます。
責める話ではありません。どの道具なら安全か、を組織で示すことが第一歩です。

【メモ】前スライド（リスク①情報の流出）と同じ「データを外に出す」話なので続けて置く。①どのアカウントで入っているか → ②そもそも組織から見えていない利用がある、という順で話す。責める話ではなく、組織で安全な道を作る話につなげる。4つの例は「うちでも起きうる」と自分の部署に置き換えてもらう。
-->
...
<div class="fill" style="font-size:19px;"><b>どんな研究か</b>　トルコの高校生 約1,000名を3群に分けた<br>数学学習の無作為化実験（米ウォートン校）。</div>

- **AIを外すと、「そのまま使った」生徒だけが下がりました**
  使用中は+48%上がっていても、テストでは対照群より17%低い成績でした。
...
<p class="note wide">2023年・GPT-4時点。ヒント型＝教員が用意したヒントを返す設定です。</p>

<!--
【原稿｜45秒】
AIに任せきりにすると、学べていないことがあります。
左のグラフをご覧ください。トルコの高校生およそ1000人を3つの群に分けた実験です。ウォートン校の研究で、査読を通った論文です。
まず、AIを使いながらの練習では、AIをそのまま使った群が48%、ヒント型で使った群が127%、成績が上がりました。ところが、AIを外してテストすると、そのまま使った群だけが対照群より17%低くなりました。ヒント型で使った生徒は下がっていません。ヒント型とは、教員が用意したヒントを返す設定のことです。
ただし、長期的な影響はまだ分かりません。使わせ方で結果が変わる、ということです。

【メモ】Wharton（ペンシルベニア大）Bastaniらの研究。トルコの高校でのRCTで、査読済みのPNAS論文。MITの「Your Brain on ChatGPT」（プレプリント）とは別物なので、混同しない。48%/127%は「AIを使いながらの練習」、−17%は「AIなしのテスト」。ヒント型（GPT Tutor）は正解と教員が用意したヒントをプロンプトに入れた特別仕様で、市販のChatGPTそのままではない点に注意。2023年秋・GPT-4時点の結果。
-->
...
<div class="ex">例：2025年4月、危険な判断まで肯定する<br>「褒めすぎるChatGPT」が数日で差し戻されました。<br>長く使う人ほど、孤独感と依存が強い傾向も出ています。</div>

</div>
</div>

<div class="takeaway">心地よいときほど要注意。学生は、話しすぎていないでしょうか</div>

<!--
【原稿｜45秒】
生成AIがよき理解者に見えるのは、そう作られているからです。
左の会話をご覧ください。この企画うまくいきますよね、と聞くと、はい、とても良い企画だと思います、と返ってきます。理由は下の枠にあります。人は、同意してくれる答えを高く評価します。その評価をもとに学習するので、AIは正しさより同意に寄ります。
実例があります。2025年4月、褒めすぎるChatGPTが公開され、危険な判断まで肯定してしまい、数日で元に戻されました。長く使う人ほど孤独感や依存が強い、という調査もあります。
心地よいときほど注意してください。学生が、AIに話しすぎていないでしょうか。

【メモ】迎合性(sycophancy)と依存。①Anthropicの研究で、RLHFで育てた5つのアシスタント全てに迎合が確認され、人間の選好データが「同意する答え」を好むことが原因と示された。②2025年4月末のGPT-4o更新は「短期的なフィードバックを重視しすぎた」ため過度に迎合的になり、OpenAIが4/29に差し戻した。③MIT/OpenAIの4週間RCT(981名・30万メッセージ)では、実験条件による有意差はなかったが、自発的な利用時間が長い人ほど孤独感・依存・問題的利用が高く、実世界の社交が少ない傾向。相関であって因果ではない点に注意。
-->
...
<div class="fill" style="font-size:21px;"><b>学習段階</b>　原則、許諾なく学習に使えます（著作権法30条の4）。<b>モデルを作る側の話</b>です。</div>

<div class="fill accent" style="font-size:21px;"><b>生成・利用段階</b><span class="pbtn">ほとんどの方はこちら</span><br><b>依拠性</b>（既存作品を見て作ったか）と<b>類似性</b>が争点。人が描いた場合と同じ判断です。</div>

<p class="note wide"><b>アウトな例</b>　教科書を丸ごと読み込ませたAIを学生に配る——著作物の共有にあたり、権利者の利益を害します。</p>
...
<!--
【原稿｜45秒】
人がやってもだめなことは、AIを使ってもだめです。
右上をご覧ください。学習の段階は、原則として許諾なく著作物を使えます。著作権法30条の4です。ただし、これはモデルを作る側の話です。
皆さんが日常で関わるのは、その下の生成・利用の段階です。争点は2つ。既存の作品を見て作ったかという依拠性と、似ているかという類似性。人が描いた場合とまったく同じ判断です。左のフローがその流れで、依拠があり、類似があり、表現の本質的な特徴を感じ取れる。この3つが揃うと侵害になります。
アウトな例を一つ。教科書を丸ごと読み込ませたAIを学生に配る。これは著作物の共有にあたります。

【メモ】広報物にAI画像を使う場面が増えるので、職員にも直結する話。学習段階はモデルを作る事業者の話で、職員が日常で関わるのは生成・利用段階だと明示する。他人の資料を添付するときは、著作権とは別に「その資料を外部サービスに渡してよいか」も確認する（リスク①の話とつながる）。
-->
...
- <span class="ss-tune" style="color:#7d1322 !important">**ハルシネーション：作り話が混ざります**</span>
  左のように、書式まで整っているので
  つい信じてしまいます。
- カットオフ：知識の「収集」には期限があり、<br>それ以降は検索機能で集めています。
</div>
</div>
...
<!--
【原稿｜45秒】
AIは、知らないことにもそれらしく答えます。
左の画面をご覧ください。保育士の離職について論文を教えて、と頼んだ回答です。著者名、論文名、雑誌名、巻号、ページまで整っています。しかし、この論文は存在しません。書式が整っているほど気づけません。これをハルシネーションと呼びます。
仕組み上こうなります。数字の並びから、それらしい続きを組み立てているだけだからです。
もう一つ、知識には期限があります。ある時点までの情報しか学習しておらず、それ以降は検索機能で補っています。
事実の最終確認は、人の仕事として残ります。

【メモ】「仕組み上そうなる」と前半1の内容につなげると腹落ちしやすい。図の文献は架空（説明用に作った再現例）で、実在の論文ではない。当日は「この誌名で検索しても出てきません」と実演してもよい。
-->
...
<!--
【原稿｜45秒】
一発で正解を求めず、直しながら使ってください。
左の図が、その回し方です。AIの出力を見る。状況を判断する。採用するか、修正するか、捨てるかを決める。そして実行し、必要なら頼み直す。この繰り返しです。
真ん中に確認を一つ挟んでください。私はこの出力を評価できるか、という問いです。評価できない領域は、下書きに留めます。
もう一つお伝えします。使わないことには上手になりません。最初の答えの出来は重要ではありません。2周目、3周目でよくなります。

【メモ】OODAループ。ワークでもこのループを体験してもらう、と予告。
-->
...
## 前半1の締めとして、2問質問させて下さい

<div class="body">

- **2-①　言語系の生成AIの仕組みは、一言で言えば、どれでしょう<span class="qtag">4択クイズ</span>**
  選択肢はSlidoの画面でご覧ください。
...
<div class="takeaway">回答後、2分だけ休憩します。9:30に再開します</div>

<!--
【原稿｜5分】
前半の締めに2問伺います。
1問目はクイズです。言語系の生成AIの仕組みは、一言で言えばどれでしょう。選択肢はSlidoの画面をご覧ください。
2問目、いまAIについて困っていることを、自由に書いてください。後半のワークと、最後の質疑で拾います。
回答が終わった方から、少し休憩してください。9時30分に再開します。
（正解は「次の一語を当て続ける機械」。正答分布を見て一言）

【メモ】【ここで Slido 2-①② を実施】クイズの正解は「次の一語を当て続ける機械」。正答分布を見て一言。
-->
...
<div class="chapter-num">前半2 ｜ 9:30 – 9:50</div>
...
<!--
【原稿｜30秒】
ここから前半の2つ目です。生成AIと大学教育。
学生、業務、大学という3つの面から考えます。
...
<!--
【原稿｜1分】
大学のいろいろな場面に、AIは影響します。今日は3つに分けます。
1つ目、学生とAI。教育と学習の場面でどう向き合うかを、守りと攻めに分けて整理します。
2つ目、業務とAI。事務や運営の仕事でどう使うかを、データを軸に考えます。
3つ目、大学とAI。大学を取り巻く環境がどう変わるかを、全国の動向から紹介します。
今日は職員の方が中心ですが、教員の話にも職員の話にも、両方に関わる内容です。

【メモ】SD研修なので職員・教員の両方に効く構成だと最初に言う。
-->
...
## 教育：授業に閉じて考えるのではなく、卒業後から考えるのがお勧めです
<div class="body">
...
- **入口で禁止するのではなく、出口（卒業後）から設計します**
  　「使えない」も「任せきり」も困ります。
  　自分で判断できる人を育てるため、段階にあわせて使える範囲を調整します。

<div class="ex">保育・福祉・医療の現場でも、記録や事務からAIが使われ始めています。</div>

</div>

<!--
【原稿｜1分】
学生とAIの話です。お勧めしたいのは、授業の中だけで考えるのではなく、卒業後から考えることです。
上の帯を左から見てください。卒業後の仕事ではAIと協働します。だから在学中に育てる力を決める。そして授業と課題を設計し直す。この順です。
入口で禁止するのではなく、出口から設計します。使えないのも困りますし、任せきりも困ります。自分で判断できる人を育てるために、段階に合わせて使える範囲を調整します。
保育、福祉、医療の現場でも、記録や事務からAIが使われ始めています。

【メモ】出口から考える。植草の学部（保育・福祉等）に引きつける。
-->
...
<b>質の高い文章を自分で作成・編集する能力が必要</b>だ。だから、練習しよう。
...
<div style="margin-top:7px;"><b>あなたは依然として最終的な成果物に責任を負う</b>。</div>
</div>
...
<div class="takeaway">「どこまで使ってよいか」と「自ら考える価値」を、先に言葉にして示します</div>

<!--
【原稿｜1分】
守りの1つ目は、ルールとその理由を決めて、学生に見せることです。
左をご覧ください。全学や課程のレベルで基本方針を示す。科目のレベルでは、使ってよい範囲とその理由をシラバスに書く。範囲は科目ごとに違ってかまいません。そして、AIを使ったことを書かせる。透明性です。
右がライティング科目の記載例です。質の高い文章を自分で書く力が必要だから、コースの前半はAIの支援を一切禁止する。この苦労は訓練だと伝える。後半は特定の条件で許可し、使ったプロンプトと応答の提出を求める。ただし最終的な成果物の責任は学生本人にある。
大事なのは、なぜ前半は禁止で後半は許可なのか、理由ごと示すことです。

【メモ】ポリシーの二層構造＋透明性。右はBowen & Watson（訳書の原著）のライティング科目シラバス例の要約（全文はFDデック 20241120_GenAIFD にある）。要点：①「なぜ前半は禁止で後半は許可か」の理由ごと学生に示す ②プロンプト提出＝透明性の担保 ③最終責任は学生。植草の科目（指導案・実習記録など）に置き換えて話す。
-->
...
- **課題・研究ごとに「使ってよい範囲」が違うことを教えます**
  <span class="ex">例：誤字脱字の確認はアウトですか？　壁打ちは？</span>
...
<svg viewBox="0 0 430 372" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="左の3項目に対応した手順の図。①使ってよい範囲を先に伝える、②印象や検出ツールで断定しない、③本人にしか答えられない問いで確かめる" style="width:100%; height:auto;"><rect x="4" y="4" width="422" height="104" rx="4" fill="#EAF3EA"/><rect x="4" y="4" width="5" height="104" fill="#2F6B3A"/><text x="24" y="42" font-size="20" font-weight="700" fill="#1E4A27">① 目標と制限を先に教える</text><text x="24" y="76" font-size="18" fill="#3F4A42">課題ごとに違う。例：誤字脱字の確認は？</text><path d="M205 112 L225 112 L215 126 Z" fill="#2F6B3A"/><rect x="4" y="130" width="422" height="112" rx="4" fill="#F4F4F2"/><rect x="4" y="130" width="5" height="112" fill="#9AA5A0"/><text x="24" y="166" font-size="20" font-weight="700" fill="#262626">② 印象や検出ツールで断定しない</text><text x="24" y="198" font-size="18" fill="#B45309">✕「AI率87%」は証拠になりません</text><text x="24" y="226" font-size="18" fill="#3F4A42">誤判定があり、冤罪の危険があります</text><path d="M205 246 L225 246 L215 260 Z" fill="#2F6B3A"/><rect x="4" y="264" width="422" height="104" rx="4" fill="#EAF3EA" stroke="#2F6B3A" stroke-width="2"/><text x="24" y="300" font-size="20" font-weight="700" fill="#1E4A27">③ 本人にしか答えられない問いで</text><text x="24" y="326" font-size="20" font-weight="700" fill="#1E4A27">　 学びを確かめる</text><text x="24" y="356" font-size="18" fill="#3F4A42">口頭試問・試験もあわせて考える</text></svg>
...
<!--
【原稿｜1分】
守りの2つ目は、不正が疑われたときの対応を、あらかじめ決めておくことです。
左の1つ目。課題や研究ごとに、使ってよい範囲が違うことを先に教えます。誤字脱字の確認はいいのか。壁打ちはどうか。ここが曖昧だと揉めます。
2つ目、AIらしい文章だという印象だけで断定しないでください。検出ツールの判定は確実ではありません。右の図のとおり、AI率87%は証拠になりません。誤判定があり、冤罪の危険があります。
3つ目、本人にしか答えられない問いで学びを確かめます。口頭試問や、持ち込みなしのテストも手です。
感情ではなく、手順で確かめてください。

【メモ】違反対応。感情的にならず、手続きで守る。教員だけでなく教務・学生課にも関わる。右の図は左の3項目と同じ順番（範囲を伝える→断定しない→本人に確かめる）。検出ツールの数値は例示で、特定製品の実測値ではない。
-->
...
<div class="takeaway">これまでの課題は「そのままでは機能しない」前提で見直します</div>

<!--
【原稿｜1分】
守りの3つ目は、課題そのものを作り替えることです。
左がMITの科目改善のフローです。まず、いまの課題をAIに解かせてみてください。どこまで解けるかで、その課題の弱点が見えます。全部解けてしまうなら、その課題はもう成績評価の役に立ちません。
次に、AIと人の分担を決めて作り替えます。結果だけでなく、途中の過程も評価するようにします。
これまでの課題は、そのままでは機能しない。その前提で見直してください。

【メモ】MITフロー。後半ワークの「課題を作り替える」シナリオの種でもある。
-->
...
## 研究で使える範囲(<a href="https://www.science.org/cms/asset/6eaae64d-ccef-41b2-acbf-72a77649def1/science_journals_guidelines_for_ai_use.pdf">例</a>)は、学会・投稿先で決まりつつあります。 <span class="lvbtn lv-dept">学科レベル</span>
...
| 原稿をAIに入れて査読する | <span class="ng">不可</span> | 機密保持に反する ／ 決めるのはAIではなく人 |
...
<!--
【原稿｜1分】
教員の方向けに、研究での話です。研究でAIを使ってよい範囲は、学会や投稿先で決まりつつあります。
表は科学誌 Science の方針です。文献の検索や下調べは可。ただし事実は自分で確かめます。言い回しや文法の校正は、軽微なら可。本文の執筆、翻訳、要約、それから解析コードやデータの生成は、開示すれば可です。謝辞にモデル名と版まで書きます。図や画像をAIで生成するのは原則不可で、編集部の許可が要ります。原稿をAIに入れて査読するのは不可です。機密保持に反しますし、決めるのはAIではなく人だからです。
AIは著者になれません。合言葉は、規定の確認と、使用の記録と開示です。
保育や教育、福祉の学会誌にも同じような規定があります。まずご自身の投稿先を見に行ってください。

【メモ】研究での関わり方。紀要・学会発表を持つ教員向け。表は「研究における生成AIの活用法」第4回（20260630_GenAI-Research_04_academic-integrity）のScience方針の表を、この研修向けに6行へ絞ったもの。 口頭で足す2点：①開示の実際＝cover letter＋謝辞に書き、methodsにプロンプト・モデル名・版まで残す。②表に載せていないが「引用の捏造・データ改ざん」は不可（研究不正）で、図のデータ改変も禁止。 植草の分野（保育・教育・福祉）の学会誌にも同種の規定があるので、「まず自分の投稿先を見に行く」を促す。
-->
...
<div class="page-title">攻め ① 学生が自ら学ぶのを支援する</div>
...
- **資料を読み込ませて、質問できる形にします**
  回答には出典がつき、元の資料に遡れます。
  聞きにくいことも、何度でも聞けます。

<div class="ex">練習問題や要約を、自分用に作れます。</div>
...
<!--
【原稿｜1分】
ここから攻めの話です。1つ目は、手持ちの資料を、質問できる教材に変えることです。
左はNotebookLMという道具の画面です。自分が持っている資料を読み込ませると、その資料だけを根拠にして答えます。回答には出典がつき、元の資料に戻って確認できます。
学生の側からすると、聞きにくいことも何度でも聞けます。国家試験の対策にも便利です。練習問題や要約を、自分用に作ることもできます。

【メモ】攻めの代表例。後半のGoogle系紹介への伏線。
-->
...
- **時間がかかりすぎた課題も、出せるようになります**
  日本大学では、橋の設計課題にAIを使い、実際の提案書類の素案を作り、
  発表するところまで到達したそうです（Googleセミナーより）。
- **学生が自ら学ぶ力を支援します**
  初年次教育にAIを使った学び方を組み込む大学も増えています。
<div class="figrow">
<div class="fill">
<div class="t">① 実務シナリオをAIで解決する課題</div>
<div class="d">実務でありそうな場面をAIで解決し、提案までを課題にします。</div>
</div>
<div class="fill">
<div class="t">② 指令書とレジュメで自習する授業</div>
<div class="d">指令書とレジュメを渡し、学生がAIと相談しながら自分のペースで進めます。</div>
</div>
</div>
...
<!--
【原稿｜1分】
攻めの2つ目は、課題の到達点そのものを引き上げることです。
これまで時間がかかりすぎて出せなかった課題も、出せるようになります。日本大学の例です。橋の設計課題にAIを使い、実際の提案書類の素案を作って、発表するところまで到達したそうです。
学生が自分で学ぶ力を支える使い方もあります。初年次教育に、AIを使った学び方を組み込む大学が増えています。
下に2つ挙げました。実務でありそうな場面をAIで解決して、提案まで作らせる課題。それから、指令書とレジュメだけ渡して、学生がAIと相談しながら自分のペースで進める授業です。
教員の負担を減らしながら、学生はより遠くまで歩けます。

【メモ】自分で学ぶ。認知的負債の話と対にして「使わせ方」を語る。
-->
...
## 学びの「伸びしろ」にも、AIは効くと期待されています <span class="lvbtn lv-all">全学レベル</span>
...
【原稿｜1分】
学びそのものへの期待も語られています。
左が2シグマ問題です。1対1の個別指導を受けた生徒は、一斉授業より2標準偏差、偏差値でいうと20ほど高い到達度になる。1984年のブルームの研究です。ただしコストの問題で、全員に個別指導はできませんでした。そこをAIが埋められるか、という期待です。
右は学び方の多様化です。左半分が、積み上げて受動的に学ぶ、学校的な学び方。どこかで頭打ちになります。右半分は、最終到達点から降りてきて探究的に学ぶ、職人や芸術家に近い学び方です。AIが伴走することで、この学び方も選べるようになります。
全員に個別の伴走がつくこと、学び方の選択肢が増えること。この2つが期待されています。

【メモ】攻め③。左＝Bloomの2シグマ問題：個別指導は一斉指導より2σ高い到達度。コスト上実現できなかった個別指導を、AIが常時・全員に近づけられるかという期待。図はFDデック（20241120_GenAIFD）の図を元にSVGで描き直し。右＝学びのモードの多様化：積み上げ型（どこかで頭打ち）に対し、到達点から降りてくる探究型をAIが伴走する。図は学生向けデック（20250611_GenAI_learn-with-ai-student）から転用。
-->
...
- **AIは、読ませたものの範囲でしか手伝えません**
  マニュアル・議事録・過去文書をクラウドに整えれば、共有財産になり引き継ぎにも効きます。

<div class="ex">最大の壁は、紙のまま・頭の中のまま・ローカルに散らばったファイル（特にExcel）です。</div>
</div>

<!--
【原稿｜1分】
ここから業務の話です。業務での活用は、データを整えるところから始まります。
上の帯のとおり、データを作る、AIに読ませる、結果を確かめて直す、という順です。AIは、読ませたものの範囲でしか手伝えません。
逆に言えば、マニュアル、議事録、過去の文書をクラウドに整えておけば、それは部署の共有財産になります。引き継ぎにも効きます。
最大の壁は、紙のままの資料、頭の中にしかない知識、そして各自のパソコンに散らばったファイルです。とくにExcelです。

【メモ】DX戦略の核。「AI導入」の前に「データづくり」。図書館の事例だが、csvの汚れを人が整える構造はどの部署の定型業務にも共通、と広げて話す。
-->
...
- **良し悪しを見極められる仕事から始めます**
  判断できない領域は、下書きに留めます。
- **確認と修正のループを、手順に組み込みます**
  一発完成を期待しないほうが早く済みます。

</div>
<div style="align-self:center;">
<div class="fill accent" style="padding:.7em .9em;">
<div class="t" style="color:var(--accent-dark);">✓ 今、やるべきこと</div>
...
【原稿｜1分】
どこまで任せるかの目安です。
左をご覧ください。良し悪しを自分で見極められる仕事から始めてください。判断できない領域は、下書きに留めます。そして、確認と修正のループを手順に組み込んでください。一発完成を期待しないほうが、結果的に早く済みます。
右上が、いまやるべきことです。まず入れてみる。データをAIに渡せる形に整える。仕事の流れそのものを見直す。
右下が、やるべきではないことです。細かい作り込みや、モデルと製品の比較。できた頃には古くなっています。元Google Cloudの橋口さんの整理です。

【メモ】前半1のOODAを業務に適用。後半の「使い分け」の予告。右パネルは橋口氏の「今、やるべきこと、やるべきではないこと」。氏の比喩をそのまま使える：データ整備＝「出汁を仕込むように、土台から」、BPRなき導入＝「器のないコース料理」、比較検討＝「サバのようなもの。比較している間に腐っていく」、Fine Tuning＝「出来た頃には古い」。乗り遅れが致命的、技術より先に人と仕組み、も口頭で補う。
-->
...
<div class="d">毎回打つプロンプトをGem化すれば、リンク1つで同僚に配れます。</div>
</div>

</div>
</div>

<div class="takeaway">「与えられたシステムを使う」から「試して」「作って」「情報共有する」のが鍵です</div>

<!--
【原稿｜1分】
1人の工夫は、部署の仕組みに育ててください。
左は、事務マニュアルを読ませて案内役にした例です。マニュアルを対話で引ける状態にすると、新人の問い合わせが減り、ベテランの負担も減ります。
右は、頼み方を固定して保存した例です。Geminiでは Gem と呼びます。毎回打っているプロンプトをGemにしておけば、リンク1つで同僚に配れます。
与えられたシステムを使う、から、試して、作って、共有する。ここが鍵になります。

【メモ】みんなで作って配る。1人の便利で終わらせない。右の動画とGemの例は千葉大「1210あかりんアワー」（ケース⑳）から。動画はHTML出力で再生（PDFではポスター画像が出る）。
-->
...
<style scoped>
  /* この回だけ設問が4問あるので、一回り小さく組む（下限18px） */
  section.slido { font-size: 21px; }
  section.slido h2 { font-size: 33px; }
  section.slido ul > li { margin: 0 0 .75em; }
  section.slido ul > li > strong:first-child { font-size: 25px; line-height: 1.4; }
  section.slido .qtag { font-size: .62em; }
</style>

<div class="page-title">Slido ③</div>

## おすすめの使い方と、お困りごとを教えてください
...
- **3-①　他の方におすすめしたい使い方を教えてください<span class="qtag">自由記述</span>**
  仕事でも私生活でも構いません。具体的に書いてください。
- **3-②　教務・雑務でどのような内容が、<br>AIで“簡単になってほしい”ですか？<span class="qtag">自由記述</span>**
  後半のワークで、シナリオを選ぶ材料になります。
- **3-③　授業・卒論など、大学教育での課題感・お困りごとを教えてください<span class="qtag">自由記述</span>**
- **3-補足（教員向け）　授業の課題と生成AIの利用の現状についてお伺いします<span class="qtag">複数回答可</span>**
...
<div class="takeaway">使えた経験も、困っていることも、どんどん共有してみて下さい</div>

<!--
【原稿｜4分】
ここで3問と、教員の方向けに1問伺います。
1問目、他の方におすすめしたい使い方を教えてください。仕事でも私生活でもかまいません。
2問目、教務や雑務で、どんな内容がAIで簡単になってほしいですか。
3問目、授業や卒論など、大学教育での課題感やお困りごとを教えてください。
最後は教員の方だけで結構です。授業の課題と、生成AIの利用の現状について伺います。
書いていただいた内容は、後半のワークでシナリオを選ぶ材料にします。
（自由記述を2〜3件読み上げる）

【メモ】【ここで Slido 3-①〜③＋補足 を実施】①の自由記述を2〜3件読み上げてから、②③を見て次のスライドの3方向につなぐ。②③の回答は後半のワークのシナリオ選びにも使う。補足は教員の方のみ回答。
-->
...
- **経営・事務：定型業務の作り直しが始まっています**
  浮いた時間をどこに使うかが、次の問いです。
- **入試・広報：受験生は、AIで大学を調べています / 戦略にも使えます**
...
<div class="d">全専任教職員を含む<b>1万ユーザー</b>に<br>Gemini有償版を導入（2026年度）。<br>生まれた時間を「知的創造時間」と位置づけます。</div>
</div>

<div class="fill">
<div class="t">学校法人立命館 ── 教職員がAIを作る</div>
<div class="d">例規集や会議録に答えるチャットボットを、<br>教職員自身が、ノーコードで作れるようにしました。</div>
</div>
...
【原稿｜1分】
大学全体への影響です。3つ挙げます。
教育と学生支援では、課題の意味が変わります。経営と事務では、定型業務の作り直しが始まっています。浮いた時間をどこに使うかが、次の問いです。入試と広報では、受験生がAIで大学を調べています。逆に、戦略にも使えます。
右に事例を2つ。日本大学は、全専任教職員を含む1万ユーザーにGeminiの有償版を導入しました。生まれた時間を知的創造時間と位置づけています。学校法人立命館は、例規集や会議録に答えるチャットボットを、教職員自身がノーコードで作れるようにしました。
日大は配る、立命館は現場が作る。方向は違いますが、どちらも職員の仕事の話です。

【メモ】影響の整理（3×3の表）をもう一度指しながら話す。右の事例はどちらもベンダー公式の導入事例が一次資料。日大＝Google Cloud公式ブログ「日本最大規模の総合大学、日本大学が挑む教学DX」（2026年5月18日）：令和8年度に全専任教職員を含む1万ユーザーへGoogle AI Pro for Education、狙いは「業務効率化で創出された知的創造時間」。立命館＝Microsoft Customer Story「学校法人立命館は“自由な挑戦”をMicrosoft 365 Copilotなどの活用によって加速」（2025年9月8日）：当初はAzure AI Foundry配布を計画したが難しく、ローコードのCopilot Studioに切替え、例規集・会議履歴を参照するチャットボットを開発。Microsoft Base Ritsumeikan（2024年4月・大阪いばらき、教育機関で全国初）は1年で学生延べ3,700人超が利用。対比は「日大＝全教職員に配る（トップダウン）／立命館＝教職員が作る（現場発）」。どちらも聴衆（職員）と地続きの話として紹介する。
-->
...
<div class="cite">大学教育学会 課題研究「高等教育における生成AI利用のガイドラインに関する研究」<a href="https://genai-higher-ed-jp.github.io/survey-2025-sep-oct/">実態調査</a>（2025年9–10月調査・n=113機関／規模別。有料AIは「未提供」に換算）</div>

</div>
<div>

- **職員向けのAI活用支援は、小規模校の61.2%が未実施です**
- **全国の重点は、研修とリテラシー教育です**
  今日のようなSD研修が、その第一歩です。
...
【原稿｜1分】
規模による差も出ています。
左のグラフです。濃い色が4000人未満の小規模、薄い色が4000人以上の大規模です。職員向けのAI活用支援が未実施の割合は、小規模で61.2%、大規模で17.9%。有料AIが未提供は81.2%と50%。システムが未整備は60%と21.4%。方針を決める予定なしは37.6%と14.3%です。
小規模の大学はこれから、という状況です。
全国の重点は、研修とリテラシー教育に置かれています。今日のようなSD研修が、その第一歩にあたります。

【メモ】外部講師の立場なので、貴学園の経営への提言はしない。全国調査の紹介と「研修・リテラシー教育が全国的な重点（70.8%・75.2%）」という事実接続まで。「小さく始める」の類は個人・現場の行動の文脈でのみ言う。
-->
...
<div class="fill">
<div class="t">仕組み</div>
<div class="d">「次に来そうな言葉」を選び続ける、確率の機械です。</div>
</div>
<div class="fill">
<div class="t">リスクと注意点</div>
<div class="d">入力が守られるかは、契約で決まります。<br>作り話と偏りは、確かめる手順で減らせます。</div>
</div>
<div class="fill">
<div class="t">学生と教育</div>
<div class="d">守り（ルール・不正対応・課題の見直し）と<br>攻め（AIで学びを支援）を、両方そろえます。</div>
</div>
<div class="fill">
<div class="t">業務と大学</div>
<div class="d">データを整え、判断できる範囲から任せ、<br>良い使い方は配ります。</div>
</div>
</div>
...
【原稿｜1分】
前半のまとめです。
左上、仕組み。生成AIは、次に来そうな言葉を選び続ける確率の機械です。
右上、リスクと注意点。入力が守られるかは契約で決まります。作り話と偏りは、確かめる手順を決めておけば減らせます。
左下、学生と教育。守りとして、ルール、不正への対応、課題の見直し。攻めとして、AIで学びを支えること。この両方を揃えます。
右下、業務と大学。データを整えて、判断できる範囲から任せて、よい使い方は配る。
前半は知る時間でした。後半は、実際に手を動かす時間にします。

【メモ】前半の総括。4つのパネルを左上から順に指しながら、ゆっくり読む。
-->
...
- **グループごとに、お手元の手順書で進めます**
  レベル1から順に。全員が同じ所まで行く必要はありません。
- **使う道具は、グループごとに分かれています**
  Gemini・NotebookLM・Copilot・Canvaの手順を用意しています。
- **成果物とインフォグラフィックを、11:10までに提出して頂きます**
...
【原稿｜1分】
休憩の前に、後半の予告です。
後半は、ご希望に沿って分かれたグループで実際に試します。お手元の手順書に沿って、レベル1から順に進めてください。全員が同じところまで行く必要はありません。
使う道具はグループごとに分かれています。Gemini、NotebookLM、Copilot、Canvaの手順を用意しました。
成果物とインフォグラフィックを、11時10分までに提出していただきます。
休憩の間に、どの方向に進めたいか考えてみてください。

【メモ】ワークの概要だけ先に。詳細は後半で。9グループは第1希望の集計で確定済み。
-->
...
<div class="chapter-num">休憩 ｜ 9:50 – 10:00</div>

# 10分休憩

## 10:00 に再開します。班の移動はこの間にどうぞ

<!--
【原稿｜10分】
10分休憩します。10時に再開します。班の移動は、この間にお願いします。
（休憩中はこの画面を出したままにする）

【メモ】休憩中はこの画面を出したままにする。
-->
...
<div class="chapter-num">後半 ｜ 10:00 – 11:20</div>
...
## Google系は、長い資料の読み込みと情報の連携が得意です

<div class="body">

| 道具 | 得意なこと |
|---|---|
| Gemini | 下書き・要約・翻訳。長い資料を読ませて質問できます |
| NotebookLM | 手持ちの資料だけを根拠に、出典つきで答えます |
| 表や記録の貼り付け | 自由記述の分類・要約など、集計の下ごしらえ |

<p class="note wide">貴学園のGoogleアカウントなら、入力は学習に使われません。</p>

- **カレンダーやDriveとも繋がり、作業を自動化できます**
  このあと、機能例で実際に見ていきます。
...
<!--
【原稿｜3分】
Google系の生成AIから紹介します。得意なのは、長い資料を読み込むことと、他のサービスとつながることです。
表をご覧ください。Geminiは、下書き、要約、翻訳。長い資料を読ませて質問できます。NotebookLMは、手持ちの資料だけを根拠にして、出典つきで答えます。3行目、表や記録を貼り付けると、自由記述の分類や要約ができます。集計の下ごしらえに使えます。
大事なことを1点。貴学園のGoogleアカウントで入っていれば、入力が学習に使われることはありません。
それから、カレンダーやDriveともつながるので、作業そのものを自動化できます。
コツは一つ。先に読ませてから聞く。これで答えの当たりがよくなります。

【メモ】Google系3分。NotebookLMは前半2の攻め①の再登場なので簡潔に。
-->
...
- **同じ画面で、AIと人が交互に直せます**
  「短く」と言えば、すぐ書き換わります。
  人の修正を踏まえて、AIがさらに直せます。

<div class="ex">スライドの叩き台も、Canvasで作れます。</div>
<div class="howto"><b>オンにする</b>　入力欄の下の <b>＋</b><span class="arw">▶</span><b>Canvas</b> を選ぶ</div>

</div>
</div>

<div class="takeaway">「ゼロからたたき台まで」を、AIと一緒に作れます</div>

<!--
【原稿｜1分45秒】
1つ目の機能はCanvasです。AIと同じ画面で、文書を共同編集できます。
左が実際の画面です。文章が画面の中に出て、短くして、と言えばその場で書き換わります。人が直した内容を踏まえて、AIがさらに直すこともできます。添削役が横にいる状態です。スライドの叩き台も、ここで作れます。
オンにする方法は、入力欄の下のプラスから Canvas を選ぶだけです。画面の版によって位置が少し違うので、実機で確認してください。
ゼロからたたき台まで、AIと一緒に作れます。

【メモ】1210あかりんアワー（ケース⑫・㉑）で反響が大きかった機能。文章を「書く」のではなく「磨く」使い方。差分が見えるので添削の理由が学べる、と一言。 オンにする手順の出典＝Geminiアプリ ヘルプ「Canvas でドキュメントやアプリなどを作成する」(support.google.com/gemini/answer/16047321)：テキストボックスの下の［ファイルを追加］(＋)アイコン → Canvas → プロンプトを入力。公式紹介ページ(gemini.google/jp/overview/canvas)は「プロンプトバーの下にある[Canvas]を選択」表記で、画面の版によって＋の中/外に出る。当日の実機で位置を確認してから話す。
-->

---

<div class="page-title">機能例② NotebookLM</div>
...
<div class="ex">音声解説・動画・スライドの形も選べます。</div>

</div>
</div>

<div class="takeaway">資料を「読む」から「ほしいところを探す」に変わります</div>

<!--
【原稿｜1分45秒】
2つ目はNotebookLMです。読み込ませた資料から、全体像の図を作れます。
左の画面が、資料をマインドマップにしたものです。要点が枝分かれして並ぶので、全体の構造が一目で分かります。図のほかに、音声解説、動画、スライドの形も選べます。
資料を最初から読む、というやり方から、ほしいところを探す、というやり方に変わります。
教材を学生に渡す前に、この教材の難しいところはどこか、と聞く使い方もできます。

【メモ】1210あかりんアワー（ケース⑱）で反響が大きかった機能。学生に渡す前に「この教材の難所はどこ？」と聞ける、という使い方も紹介できる。
-->
...
- **予定の確認も追記も、言葉で頼めます**
  Driveのファイルも、内容から探せます。

<div class="ex">先に2つのスイッチをON：Gemini側の連携設定と、Gmailのスマート機能。</div>

</div>
</div>

<div class="takeaway">連携をONにすると、Geminiが普段の作業を支援します</div>

<!--
【原稿｜1分30秒】
3つ目はアプリ連携です。アットマークを打つと、カレンダーやDriveを呼び出して、そのまま書き込めます。
左の画面は、カレンダーを呼び出して、連続講座の日程を一度に作らせたところです。予定の確認も追記も、言葉で頼めます。Driveのファイルも、ファイル名ではなく内容から探せます。
使う前にスイッチを2つ入れてください。Gemini側の連携設定と、Gmailのスマート機能です。学園のアカウント方針にもよるので、そこは確認してください。

【メモ】1210あかりんアワー（ケース②）で反響が大きかった機能。連携ONが前提なので、当日は設定画面も見せる。学園のアカウント方針に合わせて案内すること。
-->
...
<div class="ex">例：シラバスの点検係、文書の様式チェック係。<br>指示文そのものも、AIに書かせられます。</div>

</div>
</div>
<div class="takeaway">GemをつくるGemなども作成し、自動化を進めています</div>

<!--
【原稿｜1分45秒】
4つ目はGemです。よく使う頼み方を保存して、何度でも使い回せます。
左の画面は、シラバスの点検係として作ったGemです。あらかじめ指示を仕込んでおいた、専用のAIです。
作ったGemは、リンクで同僚に渡せます。ほかにも、文書の様式チェック係のような使い方ができます。指示文そのものをAIに書かせることもできます。
ChatGPTのGPTs、Copilotのエージェントも、同じ考え方です。

【メモ】Gemを作るGem。ChatGPTのGPTs、CopilotのエージェントもTLで同型と一言。
-->
...
- **Copilotも、文章・画像生成を試せます**
  ブラウザから copilot.microsoft.com で使えます。
- **WordやExcelの中で使うには、追加の契約が必要です**
  「Officeファイルの編集が直接できる」のがMS系の強みです。
- 問題をつくるなど、様々な教育向け機能があります。
...
<!--
【原稿｜1分】
Microsoft系です。強みは、Officeの中で完結できることです。
左が作成機能の画面で、画像や資料をまとめて生成できます。Copilotも、文章や画像の生成を試せます。ブラウザから copilot.microsoft.com で使えます。
ただし、WordやExcelの中で直接使うには、追加の契約が必要です。Officeファイルをそのまま編集できるところが、Microsoft系の強みです。
問題を作るなど、教育向けの機能もいろいろあります。

【メモ】MS系1分。事務系アカウントのみ・Copilotサブスクなし、を正確に。
-->
...
- **写真の背景消しや、サイズ違いへの展開が得意です**
  広報物を作り直す手間が減ります。
- かゆいところに一発で手が届く機能が多いです。

</div>

<div class="takeaway">叩き台づくりをAIに任せられるので、人気です！</div>

<!--
【原稿｜2分】
Canvaです。デザインの叩き台が、数分でできます。
ポスター、掲示、SNS用の画像の下地を、AIが数案出してくれます。スライドも、かなり簡単に作れるそうです。
得意なのは、写真の背景を消すことと、サイズ違いへの展開です。同じ内容をA4とSNS用に作り直す、といった手間が減ります。かゆいところに手が届く機能が多い道具です。
叩き台づくりを任せられるので、広報の現場で人気があります。ただし、貴学園で使える方は限られています。

【メモ】Canva2分。使える人が限られる点は正直に伝える。
-->
...
<!--
【原稿｜1分45秒】
頼み方のコツです。キーワードではなく、文章で書いてください。
図を上から見てください。1つ目、誰として答えてほしいか。役割を与えます。2つ目、何をしてほしいか。これがタスクです。3つ目、背景情報。前提や制約を渡します。4つ目、どんな形で返してほしいか。箇条書きか、表か、文字数はどれくらいか。
この4つを入れると、精度が変わります。下の段にあるように、見本を1つ付けるとさらに安定します。
人に仕事を頼むときと、同じ書き方です。

【メモ】プロンプトの基本。色分けした4要素（ペルソナ・タスク・背景情報・形式）を上から順に指す。「見本を付ける＝Few-shot」は図の下段。ワーク中に画面へ戻せるよう、このページ番号を覚えておく。
-->
...
## 手順書に基づいてAIを試し、インフォグラフィックを出して下さい

<div class="body">

| 時間 | すること |
|---|---|
| はじめの5分 | 使う道具の安全性とインフォグラフィックの作り方を確かめます |
| 〜11:10 | 手順書のレベル1から順に進めます（約50分） |
...
- **隣の人に聞く → AIに聞く → 手を挙げる、の順でどうぞ**
  数人で1台を見ながら進める形でも構いません。教え合いながら、ゲーム感覚でぜひ！

</div>

<!--
【原稿｜45秒】
ここからワークです。お手元の手順書に沿ってAIを試し、最後にインフォグラフィックを1枚出してください。
表のとおり、はじめの5分で、使う道具の安全性を確かめます。そのあと11時10分まで、手順書のレベル1から順に進めてください。11時10分から、各グループに結果を伺います。
1つお伝えします。説明は、意図的に不親切にしてあります。困ったら、手順書をそのままAIに貼って聞いてください。試行錯誤すること自体が、いちばんの練習です。
詰まったら、隣の人に聞く、AIに聞く、それでもだめなら手を挙げる。この順でどうぞ。数人で1台を見ながらでもかまいません。

【メモ】ワーク運営の要。時間割は常にこの画面に戻れるようにする。グラウンドルール（手順書をAIに貼る）はここで必ず口頭でも言う。
-->
...
## AIで作って、スクショをスライドに貼るかファイルを提出して下さい <span class="lvbtn lv-all">提出必須</span>

<div class="tcols fig-left">
<div>

<svg viewBox="0 0 600 430" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="提出するインフォグラフィックの見本。班名と題材の帯、選んだ題材・使った道具・作ったものの3枚のカード、分かったこと、下書き時間の前後比較の棒グラフで構成されている" style="width:100%; height:auto;">
...
<!--
【原稿｜45秒】
提出物の1つ、インフォグラフィックの見本です。AIで作って、スクリーンショットをスライドに貼るか、ファイルで出してください。
左が見本です。入れるのは5つだけ。班名。選んだ題材。使った道具。作ったもの。そして、やってみて分かったこと。この5つが入っていれば大丈夫です。
見た目より、やったことが伝わるほうを優先してください。うまく出なければ、手書きを写真に撮ったものでもかまいません。

【メモ】見本は架空のG-3班。「この5つが入っていればよい」と指さして言う。手書き＋写メOKを必ず口頭で添える（ここでハードルが一段下がる）。
-->
...
<style scoped>
  /* ワーク中に出しっぱなしにする手順スライド。さらに一回り大きく */
  section { font-size: 30px; }
  section table { font-size: 28px; }
  section table th, section table td { padding: .5em .8em; }
</style>
...
| 道具 | 作り方 |
|---|---|
| **Copilot** | 「画像の作成」か「ストーリー」で頼む |
| **Gemini** | Canvas か画像生成で頼む |
| **Canva** | テンプレートの文字を差し替える |
| **NotebookLM** | Studioの「インフォグラフィック」で作る |

<p class="note wide">頼み方の例：「今日のワークのまとめを1枚のインフォグラフィックに。班名・題材・道具・作ったもの・分かったことを入れて」</p>

</div>

<div class="takeaway">うまく出なければ、メモや写真でもOKです</div>

<!--
【原稿｜45秒】
作り方です。いま使っている道具で作れます。
Copilotなら、画像の作成か、ストーリーで頼んでください。Geminiなら、Canvasか画像生成です。Canvaなら、テンプレートの文字を差し替えるのがいちばん早いです。NotebookLMなら、StudioのインフォグラフィックでOKです。
頼み方の例を下に書きました。今日のワークのまとめを1枚のインフォグラフィックに、班名、題材、道具、作ったもの、分かったことを入れて。これをそのまま貼ってください。

【メモ】ワーク中はこのページを出しっぱなしにできる。道具ごとの行を指さして案内する。
-->
...
機密事項や個人の写真などは、使わないで下さい！
</div>
</div>

<!--
【原稿｜2分】
シナリオの一覧です。ご自身の班の枠を、指で押さえてください。
Aはルールを考える班。他大学の方針を調べて比べ、学生に見せる方針を1枚にします。Bは授業を進化させる班。自分の課題をAIに解かせて、伴走するGemを作ります。Cは新しい学びを創る班。学生や保護者を演じるAIで、演習を組み立てます。Dは学生との付き合い方。学生役のAIと話して、道具を見比べます。Eは業務を改善する班。17のレシピから、好きなものを選んで試します。Fは広報。Gは Copilot を深掘りします。Hはデータ分析。Iは仕事の自動化で、繰り返している作業をAIにさせます。
色は区別のためで、優劣はありません。
到達点は難しく考えないでください。AIを触ってみて、その回答を自分で修正できれば、それでOKです。
1つだけお願いします。機密事項や個人の写真は使わないでください。

【メモ】旧「シナリオと到達点 ①②」を1枚に統合。パネルは色で区別するだけで優劣は無いと一言。自分の班の枠を指で押さえてもらってから始める。9グループのばらつきは、最後の帯で1つに束ねる。ここは急がずゆっくり読む。
-->
...
1. インフォグラフィックはこのスライドに貼って下さい。
<span class="ss-tune" style="font-size:18px !important"><small>https://docs.google.com/presentation/d/1xSeh-gzaToYcCcrrDOiFcaZOYZwUE3uIciudlZzmf1c/edit?usp=sharing</small></span>
1. 成果物は、スライドに貼るか、このフォルダに、グループ名をつけた新しいフォルダを作り共有して下さい。
<span class="ss-tune" style="font-size:18px !important"><small>https://drive.google.com/drive/folders/1o0_8_s8XN1z3cfQqJ9Xc-yI9jtYOYJZv?usp=drive_link</small></span>

大学のGmailをお持ちでない場合：<a href="https://uekusagk-my.sharepoint.com/:f:/r/personal/u-kotaro_uekusa_ac_jp/Documents/%E6%A4%8D%E8%8D%89%E5%AD%A6%E5%9C%92SD%E7%A0%94%E4%BF%AE_2026?d=wdcd3d11694304d70ae9ffd402ff98e12&csf=1&web=1&e=hasrYt">こちらのOneDrive</a>にグループ番号(A-1など)を名前とし、提出して下さい。
</div>
</div>

<div class="takeaway">ワークが完了すると、皆さんが挑んだ事例集ができます。</div>
...
【原稿｜45秒】
提出について説明します。
必須はインフォグラフィック1枚です。やったこと、できたことを、AIで1枚の図にしてください。成果物は、あればで結構です。作ったツールのリンクや図があれば、ぜひ共有してください。
提出先は右にあります。インフォグラフィックは、このGoogleスライドに直接貼ってください。成果物は、スライドに貼るか、このDriveフォルダにグループ名のフォルダを作って共有してください。大学のGmailをお持ちでない方は、OneDriveのリンクから、グループ番号を名前にして提出してください。
時間はいまから50分です。提出まで終えてください。うまくいかなかった記録も歓迎します。

【メモ】提出のハードルを下げる。「失敗の記録も歓迎」を必ず言う。
-->
...
<!--
【原稿｜2分】
お疲れさまでした。いったん手を止めてください。
提出がまだの班は、リンクから提出をお願いします。1、2分お待ちします。

【メモ】11:12ごろ表示。1〜2分で回収を締める。
-->
...
<!--
【原稿｜8分】
いくつかの班に伺います。3点だけ教えてください。
何を試しましたか。選んだシナリオと使った道具を、一言でお願いします。
次に、何に気づきましたか。うまくいった点も、いかなかった点も歓迎です。
最後に、明日から使えそうですか。率直な手応えを聞かせてください。
聞きながらで結構ですので、Slidoに感想の入力もお願いします。

【メモ】【ここで Slido 感想（自由記述）を開いておく】5班×1分。時間が押したら3班に減らす。
-->
...
<div class="chapter-num">まとめ ｜ 11:20 – 11:35</div>
...
## AIは、よくわからないものですが、試す習慣があれば怖くありません
...
- **とりあえず少しずつ試して、AIを味方にしてください**
  明日の仕事で、今日の続きを一つだけやってみてください。
...
1つ目。AIは、知らないとよく分かりませんが、試す習慣があれば怖くありません。
2つ目。AIは仕事の仕方を変えますが、仕事の本質は変えません。判断すること、責任を持つこと、人と向き合うこと。ここは残ります。
3つ目。使い方が分からないことも、AIに聞けます。聞ける相手がいるだけで、一人で抱える場面は減ります。
とりあえず少しずつ試して、AIを味方にしてください。明日の仕事で、今日の続きを一つだけやってみてください。それがいちばんの近道です。

【メモ】着地のメッセージ。デザインシートの文言を崩さない。
-->
...
- **4-①　今日いちばんの気付きは何ですか。会場に共有して下さい<span class="qtag">自由記述</span>**
...
<!--
【原稿｜3分】
今日いちばんの気付きを、一言で教えてください。会場に共有します。
小さなことほど歓迎です。迷ったら、明日試すことを書いてください。
（投稿を画面に映し、いくつか読み上げる）

【メモ】【ここで Slido 4-① を実施】3分。投稿をいくつか読み上げる。
-->
...
- **4-②　課程全体を通して、どうすれば、学生が“良い文脈”を作れると思いますか？<span class="qtag">自由記述</span>**
  授業でも、カリキュラムでも、環境の話でも構いません。

<p class="note">お考えを言語化して、共有ください。</p>
...
<!--
【原稿｜3分】
もう1問伺います。課程全体を通して、どうすれば学生が良い文脈を作れると思いますか。
ここで言う文脈とは、AIに渡す材料のことです。目的、前提、手元の資料。これが揃っているほど、AIの答えはよくなります。それを学生自身が用意できるようになるには、何が要るか。
授業でも、カリキュラムでも、環境の話でもかまいません。

【メモ】【ここで Slido 4-② を実施】3分。投稿をいくつか読み上げる。
-->

---
<!-- _class: slido vcenter -->
...
- **5-①　（AIに限らず、）どんな学びを作りたいですか。学生には、どのように卒業してほしいですか<span class="qtag">自由記述</span>**
- **5-②　教育や大学業務において、AIにどんな印象をもっていらっしゃいますか？<span class="qtag">択一</span>**
  冒頭に伺った印象（1-③）からの変化を、その場で見ます。

<p class="note">5-②は、同じ画面で最初の分布と並べて映します。</p>
...
【原稿｜4分】
最後に2問です。
1問目。AIに限らず、どんな学びを作りたいですか。学生には、どのように卒業してほしいですか。
2問目。教育や大学業務において、AIにどんな印象をお持ちですか。
2問目は、今日のはじめに伺ったものと同じ質問です。並べて映しますので、ご自身の印象がどれくらい動いたか、一緒に見てみましょう。

【メモ】【ここで Slido 5-①② を実施】5-②は1-③の結果と並べて映すと変化が見える。
-->
...
【原稿｜1分30秒】
以上です。ありがとうございました。
質疑応答は11時40分から、任意参加で行います。お時間のある方はお残りください。
今日の資料は、私が企画と監修をして、生成AIを使って作りました。内容は私が確認しています。

【メモ】本資料は講師の企画・監修のもと、生成AI（Claude）を用いて作成し、内容は講師が確認しています。学長講評（11:35〜）の間はこの画面のまま。
-->
...
<!--
【原稿｜参考】
（当日は使いません。質疑で全国の状況を聞かれたときに開く）

【メモ】ここから先は当日は使わない参考スライド。質疑で数字を聞かれたときに開く。
-->
...
<div class="cite">大学教育学会 課題研究「高等教育における生成AI利用のガイドラインに関する研究」<a href="https://genai-higher-ed-jp.github.io/survey-2025-sep-oct/">調査結果</a>（2025年9月10日–10月20日、n=113機関・回答率9.8%）</div>
...
<div class="ex">策定済み45.1%＋策定中23.0%＝68.1%。<br>「予定なし」は31.9%です。</div>
...
<!--
【原稿｜参考】
（質疑用）生成AI利用のガイドラインを策定済みの機関が45.1%、策定中が23.0%、予定なしが31.9%です。策定済みでも、85.8%が実質的に機能させるのは困難だと答えています。策定済み機関の66.7%は初版のままです。方針は行き渡りましたが、動かすところが難しい、という状況です。

【メモ】大学業界全体の現在地①。方針は行き渡ったが、初版のまま・実質化が難しいという状態。植草だけの話ではないと伝える。
-->
...
<div class="ex">心配の上位は「思考力・判断力の低下」47.3%、<br>「学修成果の格差が広がる」40.9%です。</div>

</div>
</div>

<div class="takeaway">今後の重点施策（複数選択）は、学生のリテラシー教育75.2%・教職員研修70.8%</div>

<!--
【原稿｜参考】
（質疑用）生成AIの活用支援を特に行っていない機関は、教員向けで49.6%、職員向けで50.4%、学生向けで46.9%です。入学前の学生のAI利用は、85.9%の機関が把握していません。心配の上位は、思考力・判断力の低下が47.3%、学修成果の格差が広がるが40.9%です。今後重点的に取り組むべき施策としては、学生向けリテラシー教育が75.2%、教職員向け研修が70.8%で、この2つが上位に挙がっています。

【メモ】大学業界全体の現在地②。方針は進んだが支援が届いておらず、学生の実態も把握できていない。だから今日のようなSD研修が重点施策の上位に挙がっている、と今日ここに集まった意味づけにつなげる。なお「学生がAIで解いたのでは」という評価の真正性・不正利用に関する設問はこの調査には無いので、口頭で補う場合は調査結果としては語らない。
-->
